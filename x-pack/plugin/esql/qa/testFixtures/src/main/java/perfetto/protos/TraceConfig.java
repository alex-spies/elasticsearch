...
private static final long serialVersionUID = 0L;
  ...
  private TraceConfig() {
    ...
    compressionType_ = 0;
    statsdLogging_ = 0;
    sessionSemaphores_ = java.util.Collections.emptyList();
  }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            perfetto.protos.TraceConfig.class, perfetto.protos.TraceConfig.Builder.class);
  }
  ...
  public enum LockdownModeOperation
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return perfetto.protos.TraceConfig.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public enum CompressionType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return perfetto.protos.TraceConfig.getDescriptor().getEnumTypes().get(1);
    }
  ...
  public enum StatsdLogging
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return perfetto.protos.TraceConfig.getDescriptor().getEnumTypes().get(2);
    }
  ...
  public interface BufferConfigOrBuilder extends
     ...
     */
    perfetto.protos.TraceConfig.BufferConfig.FillPolicy getFillPolicy();
     ...
     * </pre>
     *
     * <code>optional bool transfer_on_clone = 5;</code>
     * @return Whether the transferOnClone field is set.
     */
     ...
     * </pre>
     *
     * <code>optional bool clear_before_clone = 6;</code>
     * @return Whether the clearBeforeClone field is set.
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BufferConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BufferConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.BufferConfig.class, perfetto.protos.TraceConfig.BufferConfig.Builder.class);
    }
    ...
    public enum FillPolicy
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return perfetto.protos.TraceConfig.BufferConfig.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The fillPolicy.
     */
    @java.lang.Override public perfetto.protos.TraceConfig.BufferConfig.FillPolicy getFillPolicy() {
      perfetto.protos.TraceConfig.BufferConfig.FillPolicy result = perfetto.protos.TraceConfig.BufferConfig.FillPolicy.forNumber(fillPolicy_);
      return result == null ? perfetto.protos.TraceConfig.BufferConfig.FillPolicy.UNSPECIFIED : result;
    }

    public static final int TRANSFER_ON_CLONE_FIELD_NUMBER = 5;
    private boolean transferOnClone_ = false;
    /**
     * <pre>
     * When true the buffer is moved (rather than copied) onto the cloned
     * session, and an empty buffer of the same size is allocated in the source
    ...
    public boolean getTransferOnClone() {
      return transferOnClone_;
    }

    public static final int CLEAR_BEFORE_CLONE_FIELD_NUMBER = 6;
    private boolean clearBeforeClone_ = false;
    /**
     * <pre>
     * Used in conjunction with transfer_on_clone. When true the buffer is
     * cleared before issuing the Flush(reason=kTraceClone). This is to ensure
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) != 0)) {
        output.writeBool(5, transferOnClone_);
      }
      if (((bitField0_ & 0x00000008) != 0)) {
        output.writeBool(6, clearBeforeClone_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, transferOnClone_);
      }
      if (((bitField0_ & 0x00000008) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(6, clearBeforeClone_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.BufferConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.BufferConfig other = (perfetto.protos.TraceConfig.BufferConfig) obj;
      ...
      if (hasTransferOnClone() != other.hasTransferOnClone()) return false;
      if (hasTransferOnClone()) {
        if (getTransferOnClone()
            != other.getTransferOnClone()) return false;
      }
      if (hasClearBeforeClone() != other.hasClearBeforeClone()) return false;
      if (hasClearBeforeClone()) {
        if (getClearBeforeClone()
            != other.getClearBeforeClone()) return false;
      }
    ...
    public int hashCode() {
      ...
      if (hasTransferOnClone()) {
        hash = (37 * hash) + TRANSFER_ON_CLONE_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
            getTransferOnClone());
      }
      if (hasClearBeforeClone()) {
        hash = (37 * hash) + CLEAR_BEFORE_CLONE_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
            getClearBeforeClone());
      }
    ...
    public static perfetto.protos.TraceConfig.BufferConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.BufferConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.BufferConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.BufferConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static perfetto.protos.TraceConfig.BufferConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.BufferConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.BufferConfig prototype) {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.BufferConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BufferConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.BufferConfig.newBuilder()
      private Builder() {
      ...
      public Builder clear() {
        ...
        sizeKb_ = 0;
        fillPolicy_ = 0;
        transferOnClone_ = false;
        clearBeforeClone_ = false;
        return this;
      }
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.BufferConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.BufferConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.BufferConfig build() {
        perfetto.protos.TraceConfig.BufferConfig result = buildPartial();
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.BufferConfig buildPartial() {
        perfetto.protos.TraceConfig.BufferConfig result = new perfetto.protos.TraceConfig.BufferConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.BufferConfig result) {
        ...
        if (((from_bitField0_ & 0x00000004) != 0)) {
          result.transferOnClone_ = transferOnClone_;
          to_bitField0_ |= 0x00000004;
        }
        if (((from_bitField0_ & 0x00000008) != 0)) {
          result.clearBeforeClone_ = clearBeforeClone_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.BufferConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.BufferConfig)other);
        } else {
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.BufferConfig other) {
        if (other == perfetto.protos.TraceConfig.BufferConfig.getDefaultInstance()) return this;
        if (other.hasSizeKb()) {
        ...
        if (other.hasTransferOnClone()) {
          setTransferOnClone(other.getTransferOnClone());
        }
        if (other.hasClearBeforeClone()) {
          setClearBeforeClone(other.getClearBeforeClone());
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 32: {
                ...
                perfetto.protos.TraceConfig.BufferConfig.FillPolicy tmpValue =
                    perfetto.protos.TraceConfig.BufferConfig.FillPolicy.forNumber(tmpRaw);
                if (tmpValue == null) {
              ...
              case 40: {
                transferOnClone_ = input.readBool();
                bitField0_ |= 0x00000004;
                break;
              } // case 40
              case 48: {
                clearBeforeClone_ = input.readBool();
       ...
       */
      @java.lang.Override
      public perfetto.protos.TraceConfig.BufferConfig.FillPolicy getFillPolicy() {
        perfetto.protos.TraceConfig.BufferConfig.FillPolicy result = perfetto.protos.TraceConfig.BufferConfig.FillPolicy.forNumber(fillPolicy_);
        return result == null ? perfetto.protos.TraceConfig.BufferConfig.FillPolicy.UNSPECIFIED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setFillPolicy(perfetto.protos.TraceConfig.BufferConfig.FillPolicy value) {
        if (value == null) {
       ...
       *
       * <code>optional bool transfer_on_clone = 5;</code>
       * @param value The transferOnClone to set.
       * @return This builder for chaining.
       */
      public Builder setTransferOnClone(boolean value) {
        
        transferOnClone_ = value;
        bitField0_ |= 0x00000004;
        onChanged();
        return this;
      }
       ...
       *
       * <code>optional bool clear_before_clone = 6;</code>
       * @param value The clearBeforeClone to set.
       * @return This builder for chaining.
       */
      public Builder setClearBeforeClone(boolean value) {
        
        clearBeforeClone_ = value;
        bitField0_ |= 0x00000008;
        onChanged();
        return this;
      }
    ...
    private static final perfetto.protos.TraceConfig.BufferConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.BufferConfig();
    }

    public static perfetto.protos.TraceConfig.BufferConfig getDefaultInstance() {
  ...
  public interface DataSourceOrBuilder extends
     ...
     * @return The config.
     */
    perfetto.protos.DataSourceConfig getConfig();
    /**
     * <pre>
     * Filters and data-source specific config. It contains also the unique name
     * of the data source, the one passed in the  DataSourceDescriptor when they
     ...
     * <code>optional .perfetto.protos.DataSourceConfig config = 1;</code>
     */
    perfetto.protos.DataSourceConfigOrBuilder getConfigOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_DataSource_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_DataSource_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.DataSource.class, perfetto.protos.TraceConfig.DataSource.Builder.class);
    }

    private int bitField0_;
    public static final int CONFIG_FIELD_NUMBER = 1;
    private perfetto.protos.DataSourceConfig config_;
    /**
     * <pre>
     * Filters and data-source specific config. It contains also the unique name
     * of the data source, the one passed in the  DataSourceDescriptor when they
     ...
     */
    @java.lang.Override
    public perfetto.protos.DataSourceConfig getConfig() {
      return config_ == null ? perfetto.protos.DataSourceConfig.getDefaultInstance() : config_;
    }
    /**
     * <pre>
     * Filters and data-source specific config. It contains also the unique name
     ...
     */
    @java.lang.Override
    public perfetto.protos.DataSourceConfigOrBuilder getConfigOrBuilder() {
      return config_ == null ? perfetto.protos.DataSourceConfig.getDefaultInstance() : config_;
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.DataSource)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.DataSource other = (perfetto.protos.TraceConfig.DataSource) obj;
    ...
    public static perfetto.protos.TraceConfig.DataSource parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.DataSource parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.DataSource parseFrom(
    ...
    public static perfetto.protos.TraceConfig.DataSource parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.DataSource parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.DataSource parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.DataSource prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.DataSourceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_DataSource_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.DataSource.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.DataSource getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.DataSource.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.DataSource build() {
        perfetto.protos.TraceConfig.DataSource result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.DataSource buildPartial() {
        perfetto.protos.TraceConfig.DataSource result = new perfetto.protos.TraceConfig.DataSource(this);
      ...
      private void buildPartialRepeatedFields(perfetto.protos.TraceConfig.DataSource result) {
        if (((bitField0_ & 0x00000002) != 0)) {
      ...
      private void buildPartial0(perfetto.protos.TraceConfig.DataSource result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.DataSource) {
          return mergeFrom((perfetto.protos.TraceConfig.DataSource)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.DataSource other) {
        if (other == perfetto.protos.TraceConfig.DataSource.getDefaultInstance()) return this;
        if (other.hasConfig()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          perfetto.protos.DataSourceConfig, perfetto.protos.DataSourceConfig.Builder, perfetto.protos.DataSourceConfigOrBuilder> configBuilder_;
      /**
       * <pre>
       * Filters and data-source specific config. It contains also the unique name
       * of the data source, the one passed in the  DataSourceDescriptor when they
       ...
       * <code>optional .perfetto.protos.DataSourceConfig config = 1;</code>
       */
      public Builder setConfig(perfetto.protos.DataSourceConfig value) {
        if (configBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setConfig(
          perfetto.protos.DataSourceConfig.Builder builderForValue) {
        if (configBuilder_ == null) {
       ...
       * <code>optional .perfetto.protos.DataSourceConfig config = 1;</code>
       */
      public Builder mergeConfig(perfetto.protos.DataSourceConfig value) {
        if (configBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            config_ != null &&
            config_ != perfetto.protos.DataSourceConfig.getDefaultInstance()) {
       ...
       * <code>optional .perfetto.protos.DataSourceConfig config = 1;</code>
       */
      public perfetto.protos.DataSourceConfig.Builder getConfigBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
      ...
      public perfetto.protos.DataSourceConfigOrBuilder getConfigOrBuilder() {
        if (configBuilder_ != null) {
          ...
          return config_ == null ?
              perfetto.protos.DataSourceConfig.getDefaultInstance() : config_;
        }
      }
      /**
       * <pre>
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          perfetto.protos.DataSourceConfig, perfetto.protos.DataSourceConfig.Builder, perfetto.protos.DataSourceConfigOrBuilder> 
          getConfigFieldBuilder() {
        if (configBuilder_ == null) {
    ...
    private static final perfetto.protos.TraceConfig.DataSource DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.DataSource();
    }

    public static perfetto.protos.TraceConfig.DataSource getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface BuiltinDataSourceOrBuilder extends
     ...
     * </pre>
     *
     * <code>optional bool prefer_suspend_clock_for_snapshot = 7 [deprecated = true];</code>
     * @deprecated perfetto.protos.TraceConfig.BuiltinDataSource.prefer_suspend_clock_for_snapshot is deprecated.
     *     See protos/perfetto/trace/perfetto_trace.proto;l=3998
     * @return Whether the preferSuspendClockForSnapshot field is set.
     */
    @java.lang.Deprecated boolean hasPreferSuspendClockForSnapshot();
    /**
     * <pre>
     * Formerly controlled whether a suspend-aware clock was used (if available)
     * for periodic snapshots of service-emitted events.
     ...
     */
    @java.lang.Deprecated boolean getPreferSuspendClockForSnapshot();
     ...
     * </pre>
     *
     * <code>optional bool disable_chunk_usage_histograms = 8;</code>
     * @return Whether the disableChunkUsageHistograms field is set.
     */
     ...
     *
     * <code>optional bool disable_chunk_usage_histograms = 8;</code>
     * @return The disableChunkUsageHistograms.
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BuiltinDataSource_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BuiltinDataSource_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.BuiltinDataSource.class, perfetto.protos.TraceConfig.BuiltinDataSource.Builder.class);
    }
     ...
     * @return The primaryTraceClock.
     */
    @java.lang.Override public perfetto.protos.BuiltinClock getPrimaryTraceClock() {
      perfetto.protos.BuiltinClock result = perfetto.protos.BuiltinClock.forNumber(primaryTraceClock_);
      return result == null ? perfetto.protos.BuiltinClock.BUILTIN_CLOCK_UNKNOWN : result;
    }
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean hasPreferSuspendClockForSnapshot() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean getPreferSuspendClockForSnapshot() {
      return preferSuspendClockForSnapshot_;
    }

    public static final int DISABLE_CHUNK_USAGE_HISTOGRAMS_FIELD_NUMBER = 8;
    private boolean disableChunkUsageHistograms_ = false;
    /**
     * <pre>
     * Disables the reporting of per-trace-writer histograms in TraceStats.
     * </pre>
    ...
    public boolean getDisableChunkUsageHistograms() {
      return disableChunkUsageHistograms_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000080) != 0)) {
        output.writeBool(8, disableChunkUsageHistograms_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000080) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, disableChunkUsageHistograms_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.BuiltinDataSource)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.BuiltinDataSource other = (perfetto.protos.TraceConfig.BuiltinDataSource) obj;
      ...
      if (hasDisableChunkUsageHistograms() != other.hasDisableChunkUsageHistograms()) return false;
      if (hasDisableChunkUsageHistograms()) {
        if (getDisableChunkUsageHistograms()
            != other.getDisableChunkUsageHistograms()) return false;
      }
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      if (hasDisableChunkUsageHistograms()) {
        hash = (37 * hash) + DISABLE_CHUNK_USAGE_HISTOGRAMS_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
            getDisableChunkUsageHistograms());
      }
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseFrom(
    ...
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.BuiltinDataSource parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.BuiltinDataSource prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.BuiltinDataSourceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_BuiltinDataSource_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.BuiltinDataSource.newBuilder()
      private Builder() {
      ...
      public Builder clear() {
        ...
        disableChunkUsageHistograms_ = false;
        return this;
      }
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.BuiltinDataSource getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.BuiltinDataSource build() {
        perfetto.protos.TraceConfig.BuiltinDataSource result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.BuiltinDataSource buildPartial() {
        perfetto.protos.TraceConfig.BuiltinDataSource result = new perfetto.protos.TraceConfig.BuiltinDataSource(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.BuiltinDataSource result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        if (((from_bitField0_ & 0x00000080) != 0)) {
          result.disableChunkUsageHistograms_ = disableChunkUsageHistograms_;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.BuiltinDataSource) {
          return mergeFrom((perfetto.protos.TraceConfig.BuiltinDataSource)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.BuiltinDataSource other) {
        if (other == perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance()) return this;
        ...
        if (other.hasDisableChunkUsageHistograms()) {
          setDisableChunkUsageHistograms(other.getDisableChunkUsageHistograms());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 40: {
                int tmpRaw = input.readEnum();
                perfetto.protos.BuiltinClock tmpValue =
                    perfetto.protos.BuiltinClock.forNumber(tmpRaw);
                if (tmpValue == null) {
              ...
              case 64: {
                disableChunkUsageHistograms_ = input.readBool();
       ...
       */
      @java.lang.Override
      public perfetto.protos.BuiltinClock getPrimaryTraceClock() {
        perfetto.protos.BuiltinClock result = perfetto.protos.BuiltinClock.forNumber(primaryTraceClock_);
        return result == null ? perfetto.protos.BuiltinClock.BUILTIN_CLOCK_UNKNOWN : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setPrimaryTraceClock(perfetto.protos.BuiltinClock value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000010;
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder setPreferSuspendClockForSnapshot(boolean value) {
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder clearPreferSuspendClockForSnapshot() {
       ...
       *
       * <code>optional bool disable_chunk_usage_histograms = 8;</code>
       * @param value The disableChunkUsageHistograms to set.
       * @return This builder for chaining.
       */
      public Builder setDisableChunkUsageHistograms(boolean value) {
        
        disableChunkUsageHistograms_ = value;
        bitField0_ |= 0x00000080;
        onChanged();
        return this;
      }
    ...
    private static final perfetto.protos.TraceConfig.BuiltinDataSource DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.BuiltinDataSource();
    }

    public static perfetto.protos.TraceConfig.BuiltinDataSource getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_ProducerConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_ProducerConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.ProducerConfig.class, perfetto.protos.TraceConfig.ProducerConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.ProducerConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.ProducerConfig other = (perfetto.protos.TraceConfig.ProducerConfig) obj;
    ...
    public static perfetto.protos.TraceConfig.ProducerConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.ProducerConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.ProducerConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.ProducerConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.ProducerConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.ProducerConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.ProducerConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.ProducerConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_ProducerConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.ProducerConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.ProducerConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.ProducerConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.ProducerConfig build() {
        perfetto.protos.TraceConfig.ProducerConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.ProducerConfig buildPartial() {
        perfetto.protos.TraceConfig.ProducerConfig result = new perfetto.protos.TraceConfig.ProducerConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.ProducerConfig result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.ProducerConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.ProducerConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.ProducerConfig other) {
        if (other == perfetto.protos.TraceConfig.ProducerConfig.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.ProducerConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.ProducerConfig();
    }

    public static perfetto.protos.TraceConfig.ProducerConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_StatsdMetadata_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_StatsdMetadata_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.StatsdMetadata.class, perfetto.protos.TraceConfig.StatsdMetadata.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.StatsdMetadata)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.StatsdMetadata other = (perfetto.protos.TraceConfig.StatsdMetadata) obj;
    ...
    public static perfetto.protos.TraceConfig.StatsdMetadata parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.StatsdMetadata parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.StatsdMetadata parseFrom(
    ...
    public static perfetto.protos.TraceConfig.StatsdMetadata parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.StatsdMetadata parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.StatsdMetadata parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.StatsdMetadata prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.StatsdMetadataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_StatsdMetadata_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.StatsdMetadata.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.StatsdMetadata getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.StatsdMetadata build() {
        perfetto.protos.TraceConfig.StatsdMetadata result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.StatsdMetadata buildPartial() {
        perfetto.protos.TraceConfig.StatsdMetadata result = new perfetto.protos.TraceConfig.StatsdMetadata(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.StatsdMetadata result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.StatsdMetadata) {
          return mergeFrom((perfetto.protos.TraceConfig.StatsdMetadata)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.StatsdMetadata other) {
        if (other == perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.StatsdMetadata DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.StatsdMetadata();
    }

    public static perfetto.protos.TraceConfig.StatsdMetadata getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface GuardrailOverridesOrBuilder extends
     ...
     * </pre>
     *
     * <code>optional uint64 max_upload_per_day_bytes = 1 [deprecated = true];</code>
     * @deprecated perfetto.protos.TraceConfig.GuardrailOverrides.max_upload_per_day_bytes is deprecated.
     *     See protos/perfetto/trace/perfetto_trace.proto;l=4102
     * @return Whether the maxUploadPerDayBytes field is set.
     */
    @java.lang.Deprecated boolean hasMaxUploadPerDayBytes();
    /**
     * <pre>
     * Override the default limit (in bytes) for uploading data to server within
     * a 24 hour period.
     ...
     */
    @java.lang.Deprecated long getMaxUploadPerDayBytes();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_GuardrailOverrides_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_GuardrailOverrides_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.GuardrailOverrides.class, perfetto.protos.TraceConfig.GuardrailOverrides.Builder.class);
    }
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean hasMaxUploadPerDayBytes() {
      return ((bitField0_ & 0x00000001) != 0);
    }
    /**
     * <pre>
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public long getMaxUploadPerDayBytes() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.GuardrailOverrides)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.GuardrailOverrides other = (perfetto.protos.TraceConfig.GuardrailOverrides) obj;
    ...
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseFrom(
    ...
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.GuardrailOverrides parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.GuardrailOverrides prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.GuardrailOverridesOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_GuardrailOverrides_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.GuardrailOverrides.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.GuardrailOverrides getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.GuardrailOverrides build() {
        perfetto.protos.TraceConfig.GuardrailOverrides result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.GuardrailOverrides buildPartial() {
        perfetto.protos.TraceConfig.GuardrailOverrides result = new perfetto.protos.TraceConfig.GuardrailOverrides(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.GuardrailOverrides result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.GuardrailOverrides) {
          return mergeFrom((perfetto.protos.TraceConfig.GuardrailOverrides)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.GuardrailOverrides other) {
        if (other == perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance()) return this;
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder setMaxUploadPerDayBytes(long value) {
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder clearMaxUploadPerDayBytes() {
        bitField0_ = (bitField0_ & ~0x00000001);
        maxUploadPerDayBytes_ = 0L;
        onChanged();
        return this;
    ...
    private static final perfetto.protos.TraceConfig.GuardrailOverrides DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.GuardrailOverrides();
    }

    public static perfetto.protos.TraceConfig.GuardrailOverrides getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface TriggerConfigOrBuilder extends
     ...
     */
    perfetto.protos.TraceConfig.TriggerConfig.TriggerMode getTriggerMode();
     ...
     * </pre>
     *
     * <code>optional bool use_clone_snapshot_if_available = 5;</code>
     * @return Whether the useCloneSnapshotIfAvailable field is set.
     */
     ...
     *
     * <code>optional bool use_clone_snapshot_if_available = 5;</code>
     * @return The useCloneSnapshotIfAvailable.
     */
     ...
     */
    java.util.List<perfetto.protos.TraceConfig.TriggerConfig.Trigger> 
        getTriggersList();
    /**
     * <pre>
     * A list of triggers which are related to this configuration. If ANY
     ...
     * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
     */
    perfetto.protos.TraceConfig.TriggerConfig.Trigger getTriggers(int index);
    /**
     * <pre>
     * A list of triggers which are related to this configuration. If ANY
     * trigger is seen then an action will be performed based on |trigger_mode|.
     ...
     * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
     */
    java.util.List<? extends perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder> 
     ...
     * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
     */
    perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder getTriggersOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.TriggerConfig.class, perfetto.protos.TraceConfig.TriggerConfig.Builder.class);
    }
    ...
    public enum TriggerMode
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return perfetto.protos.TraceConfig.TriggerConfig.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_Trigger_descriptor;
      }

      @java.lang.Override
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_Trigger_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                perfetto.protos.TraceConfig.TriggerConfig.Trigger.class, perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder.class);
      }
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof perfetto.protos.TraceConfig.TriggerConfig.Trigger)) {
          return super.equals(obj);
        }
        perfetto.protos.TraceConfig.TriggerConfig.Trigger other = (perfetto.protos.TraceConfig.TriggerConfig.Trigger) obj;
      ...
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseFrom(
          java.nio.ByteBuffer data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseFrom(
      ...
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(perfetto.protos.TraceConfig.TriggerConfig.Trigger prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      @java.lang.Override
      public Builder toBuilder() {
      ...
      public static final class Builder extends
          ...
          perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_Trigger_descriptor;
        }
        ...
        // Construct using perfetto.protos.TraceConfig.TriggerConfig.Trigger.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TriggerConfig.Trigger getDefaultInstanceForType() {
          return perfetto.protos.TraceConfig.TriggerConfig.Trigger.getDefaultInstance();
        }

        @java.lang.Override
        public perfetto.protos.TraceConfig.TriggerConfig.Trigger build() {
          perfetto.protos.TraceConfig.TriggerConfig.Trigger result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TriggerConfig.Trigger buildPartial() {
          perfetto.protos.TraceConfig.TriggerConfig.Trigger result = new perfetto.protos.TraceConfig.TriggerConfig.Trigger(this);
          if (bitField0_ != 0) { buildPartial0(result); }
          onBuilt();
          return result;
        }

        private void buildPartial0(perfetto.protos.TraceConfig.TriggerConfig.Trigger result) {
          int from_bitField0_ = bitField0_;
          int to_bitField0_ = 0;
          if (((from_bitField0_ & 0x00000001) != 0)) {
            result.name_ = name_;
        ...
        @java.lang.Override
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof perfetto.protos.TraceConfig.TriggerConfig.Trigger) {
            return mergeFrom((perfetto.protos.TraceConfig.TriggerConfig.Trigger)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(perfetto.protos.TraceConfig.TriggerConfig.Trigger other) {
          if (other == perfetto.protos.TraceConfig.TriggerConfig.Trigger.getDefaultInstance()) return this;
          if (other.hasName()) {
            name_ = other.name_;
            bitField0_ |= 0x00000001;
            onChanged();
      ...
      private static final perfetto.protos.TraceConfig.TriggerConfig.Trigger DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.TriggerConfig.Trigger();
      }

      public static perfetto.protos.TraceConfig.TriggerConfig.Trigger getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }
     ...
     * @return The triggerMode.
     */
    @java.lang.Override public perfetto.protos.TraceConfig.TriggerConfig.TriggerMode getTriggerMode() {
      perfetto.protos.TraceConfig.TriggerConfig.TriggerMode result = perfetto.protos.TraceConfig.TriggerConfig.TriggerMode.forNumber(triggerMode_);
      return result == null ? perfetto.protos.TraceConfig.TriggerConfig.TriggerMode.UNSPECIFIED : result;
    }

    public static final int USE_CLONE_SNAPSHOT_IF_AVAILABLE_FIELD_NUMBER = 5;
    private boolean useCloneSnapshotIfAvailable_ = false;
    /**
     * <pre>
     * This flag is really a workaround for b/274931668. This is needed only
     * when deploying configs to different versions of the tracing service.
    ...
    public boolean getUseCloneSnapshotIfAvailable() {
      return useCloneSnapshotIfAvailable_;
    }

    public static final int TRIGGERS_FIELD_NUMBER = 2;
    @SuppressWarnings("serial")
    private java.util.List<perfetto.protos.TraceConfig.TriggerConfig.Trigger> triggers_;
    /**
     * <pre>
     * A list of triggers which are related to this configuration. If ANY
     * trigger is seen then an action will be performed based on |trigger_mode|.
     ...
     */
    @java.lang.Override
    public java.util.List<perfetto.protos.TraceConfig.TriggerConfig.Trigger> getTriggersList() {
      return triggers_;
    }
    /**
     * <pre>
     ...
     */
    @java.lang.Override
    public java.util.List<? extends perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder> 
        getTriggersOrBuilderList() {
      return triggers_;
    }
    /**
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.TriggerConfig.Trigger getTriggers(int index) {
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder getTriggersOrBuilder(
        int index) {
      return triggers_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        output.writeBool(5, useCloneSnapshotIfAvailable_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, useCloneSnapshotIfAvailable_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.TriggerConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.TriggerConfig other = (perfetto.protos.TraceConfig.TriggerConfig) obj;

      if (hasTriggerMode() != other.hasTriggerMode()) return false;
      if (hasTriggerMode()) {
        if (triggerMode_ != other.triggerMode_) return false;
      }
      if (hasUseCloneSnapshotIfAvailable() != other.hasUseCloneSnapshotIfAvailable()) return false;
      if (hasUseCloneSnapshotIfAvailable()) {
        if (getUseCloneSnapshotIfAvailable()
            != other.getUseCloneSnapshotIfAvailable()) return false;
      }
      if (!getTriggersList()
    ...
    public int hashCode() {
      ...
      if (hasUseCloneSnapshotIfAvailable()) {
        hash = (37 * hash) + USE_CLONE_SNAPSHOT_IF_AVAILABLE_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
            getUseCloneSnapshotIfAvailable());
      }
    ...
    public static perfetto.protos.TraceConfig.TriggerConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.TriggerConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.TriggerConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.TriggerConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.TriggerConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.TriggerConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.TriggerConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.TriggerConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TriggerConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.TriggerConfig.newBuilder()
      private Builder() {
      ...
      public Builder clear() {
        ...
        bitField0_ = 0;
        triggerMode_ = 0;
        useCloneSnapshotIfAvailable_ = false;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.TriggerConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.TriggerConfig build() {
        perfetto.protos.TraceConfig.TriggerConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.TriggerConfig buildPartial() {
        perfetto.protos.TraceConfig.TriggerConfig result = new perfetto.protos.TraceConfig.TriggerConfig(this);
        buildPartialRepeatedFields(result);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      ...
      private void buildPartialRepeatedFields(perfetto.protos.TraceConfig.TriggerConfig result) {
        if (triggersBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0)) {
      ...
      private void buildPartial0(perfetto.protos.TraceConfig.TriggerConfig result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          result.useCloneSnapshotIfAvailable_ = useCloneSnapshotIfAvailable_;
          to_bitField0_ |= 0x00000002;
        }
        if (((from_bitField0_ & 0x00000008) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.TriggerConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.TriggerConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.TriggerConfig other) {
        if (other == perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance()) return this;
        if (other.hasTriggerMode()) {
          setTriggerMode(other.getTriggerMode());
        }
        if (other.hasUseCloneSnapshotIfAvailable()) {
          setUseCloneSnapshotIfAvailable(other.getUseCloneSnapshotIfAvailable());
        }
        if (triggersBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 8: {
                int tmpRaw = input.readEnum();
                perfetto.protos.TraceConfig.TriggerConfig.TriggerMode tmpValue =
                    perfetto.protos.TraceConfig.TriggerConfig.TriggerMode.forNumber(tmpRaw);
                if (tmpValue == null) {
              ...
              case 18: {
                perfetto.protos.TraceConfig.TriggerConfig.Trigger m =
                    input.readMessage(
                        perfetto.protos.TraceConfig.TriggerConfig.Trigger.PARSER,
                        extensionRegistry);
                if (triggersBuilder_ == null) {
                  ensureTriggersIsMutable();
                  triggers_.add(m);
              ...
              case 40: {
                useCloneSnapshotIfAvailable_ = input.readBool();
                bitField0_ |= 0x00000002;
                break;
              } // case 40
              default: {
       ...
       */
      @java.lang.Override
      public perfetto.protos.TraceConfig.TriggerConfig.TriggerMode getTriggerMode() {
        perfetto.protos.TraceConfig.TriggerConfig.TriggerMode result = perfetto.protos.TraceConfig.TriggerConfig.TriggerMode.forNumber(triggerMode_);
        return result == null ? perfetto.protos.TraceConfig.TriggerConfig.TriggerMode.UNSPECIFIED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setTriggerMode(perfetto.protos.TraceConfig.TriggerConfig.TriggerMode value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000001;
       ...
       *
       * <code>optional bool use_clone_snapshot_if_available = 5;</code>
       * @param value The useCloneSnapshotIfAvailable to set.
       * @return This builder for chaining.
       */
      public Builder setUseCloneSnapshotIfAvailable(boolean value) {
        
        useCloneSnapshotIfAvailable_ = value;
        bitField0_ |= 0x00000002;
        onChanged();
        return this;
      }
      ...
      private void ensureTriggersIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          triggers_ = new java.util.ArrayList<perfetto.protos.TraceConfig.TriggerConfig.Trigger>(triggers_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          perfetto.protos.TraceConfig.TriggerConfig.Trigger, perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder, perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder> triggersBuilder_;
      ...
      public Builder setTriggers(
          int index, perfetto.protos.TraceConfig.TriggerConfig.Trigger value) {
        if (triggersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setTriggers(
          int index, perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder builderForValue) {
        if (triggersBuilder_ == null) {
          ensureTriggersIsMutable();
       ...
       * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
       */
      public Builder addTriggers(perfetto.protos.TraceConfig.TriggerConfig.Trigger value) {
        if (triggersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTriggers(
          perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder builderForValue) {
        if (triggersBuilder_ == null) {
          ensureTriggersIsMutable();
      ...
      public Builder addAllTriggers(
          java.lang.Iterable<? extends perfetto.protos.TraceConfig.TriggerConfig.Trigger> values) {
        if (triggersBuilder_ == null) {
          ensureTriggersIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, triggers_);
       ...
       * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
       */
      public perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder getTriggersBuilder(
          int index) {
       ...
       * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
       */
      public perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder addTriggersBuilder() {
        return getTriggersFieldBuilder().addBuilder(
            perfetto.protos.TraceConfig.TriggerConfig.Trigger.getDefaultInstance());
      }
      /**
       * <pre>
       * A list of triggers which are related to this configuration. If ANY
      ...
      public perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder addTriggersBuilder(
          int index) {
        return getTriggersFieldBuilder().addBuilder(
            index, perfetto.protos.TraceConfig.TriggerConfig.Trigger.getDefaultInstance());
      }
      /**
       * <pre>
       * A list of triggers which are related to this configuration. If ANY
       ...
       * <code>repeated .perfetto.protos.TraceConfig.TriggerConfig.Trigger triggers = 2;</code>
       */
      public java.util.List<perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder> 
           getTriggersBuilderList() {
        return getTriggersFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          perfetto.protos.TraceConfig.TriggerConfig.Trigger, perfetto.protos.TraceConfig.TriggerConfig.Trigger.Builder, perfetto.protos.TraceConfig.TriggerConfig.TriggerOrBuilder> 
    ...
    private static final perfetto.protos.TraceConfig.TriggerConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.TriggerConfig();
    }

    public static perfetto.protos.TraceConfig.TriggerConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncrementalStateConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncrementalStateConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.IncrementalStateConfig.class, perfetto.protos.TraceConfig.IncrementalStateConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.IncrementalStateConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.IncrementalStateConfig other = (perfetto.protos.TraceConfig.IncrementalStateConfig) obj;
    ...
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.IncrementalStateConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.IncrementalStateConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.IncrementalStateConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncrementalStateConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.IncrementalStateConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.IncrementalStateConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.IncrementalStateConfig build() {
        perfetto.protos.TraceConfig.IncrementalStateConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.IncrementalStateConfig buildPartial() {
        perfetto.protos.TraceConfig.IncrementalStateConfig result = new perfetto.protos.TraceConfig.IncrementalStateConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.IncrementalStateConfig result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.IncrementalStateConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.IncrementalStateConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.IncrementalStateConfig other) {
        if (other == perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.IncrementalStateConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.IncrementalStateConfig();
    }

    public static perfetto.protos.TraceConfig.IncrementalStateConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface IncidentReportConfigOrBuilder extends
     ...
     *     See protos/perfetto/trace/perfetto_trace.proto;l=4352
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncidentReportConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncidentReportConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.IncidentReportConfig.class, perfetto.protos.TraceConfig.IncidentReportConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.IncidentReportConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.IncidentReportConfig other = (perfetto.protos.TraceConfig.IncidentReportConfig) obj;
    ...
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.IncidentReportConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.IncidentReportConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.IncidentReportConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_IncidentReportConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.IncidentReportConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.IncidentReportConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.IncidentReportConfig build() {
        perfetto.protos.TraceConfig.IncidentReportConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.IncidentReportConfig buildPartial() {
        perfetto.protos.TraceConfig.IncidentReportConfig result = new perfetto.protos.TraceConfig.IncidentReportConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.IncidentReportConfig result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.IncidentReportConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.IncidentReportConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.IncidentReportConfig other) {
        if (other == perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.IncidentReportConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.IncidentReportConfig();
    }

    public static perfetto.protos.TraceConfig.IncidentReportConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface TraceFilterOrBuilder extends
     ...
     * </pre>
     *
     * <code>optional bytes bytecode_v2 = 2;</code>
     * @return Whether the bytecodeV2 field is set.
     */
     ...
     *
     * <code>optional bytes bytecode_v2 = 2;</code>
     * @return The bytecodeV2.
     */
    com.google.protobuf.ByteString getBytecodeV2();

    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
     * @return Whether the stringFilterChain field is set.
     */
    boolean hasStringFilterChain();
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
     * @return The stringFilterChain.
     */
    perfetto.protos.TraceConfig.TraceFilter.StringFilterChain getStringFilterChain();
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
     */
    perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder getStringFilterChainOrBuilder();
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    private TraceFilter() {
      ...
      bytecodeV2_ = com.google.protobuf.ByteString.EMPTY;
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.TraceFilter.class, perfetto.protos.TraceConfig.TraceFilter.Builder.class);
    }
     ...
     * </pre>
     *
     * Protobuf enum {@code perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy}
     */
    public enum StringFilterPolicy
        implements com.google.protobuf.ProtocolMessageEnum {
      /**
       * <code>SFP_UNSPECIFIED = 0;</code>
       */
      SFP_UNSPECIFIED(0),
      /**
       * <pre>
       ...
       * </pre>
       *
       * <code>SFP_MATCH_REDACT_GROUPS = 1;</code>
       */
       ...
       * </pre>
       *
       * <code>SFP_ATRACE_MATCH_REDACT_GROUPS = 2;</code>
       */
       ...
       * </pre>
       *
       * <code>SFP_ATRACE_MATCH_BREAK = 4;</code>
       */
       ...
       * </pre>
       *
       * <code>SFP_ATRACE_REPEATED_SEARCH_REDACT_GROUPS = 5;</code>
       */
       ...
       */
      @java.lang.Deprecated
      public static StringFilterPolicy valueOf(int value) {
        return forNumber(value);
      }
       ...
       * @return The enum associated with the given numeric wire value.
       */
      public static StringFilterPolicy forNumber(int value) {
        switch (value) {
          case 0: return SFP_UNSPECIFIED;
          case 1: return SFP_MATCH_REDACT_GROUPS;
          case 2: return SFP_ATRACE_MATCH_REDACT_GROUPS;
          case 3: return SFP_MATCH_BREAK;
          case 4: return SFP_ATRACE_MATCH_BREAK;
          case 5: return SFP_ATRACE_REPEATED_SEARCH_REDACT_GROUPS;
          default: return null;
        }
      }

      public static com.google.protobuf.Internal.EnumLiteMap<StringFilterPolicy>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static final com.google.protobuf.Internal.EnumLiteMap<
          StringFilterPolicy> internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<StringFilterPolicy>() {
              public StringFilterPolicy findValueByNumber(int number) {
                return StringFilterPolicy.forNumber(number);
              }
            };
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return perfetto.protos.TraceConfig.TraceFilter.getDescriptor().getEnumTypes().get(0);
      }

      private static final StringFilterPolicy[] VALUES = values();

      public static StringFilterPolicy valueOf(
          com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != getDescriptor()) {
          throw new java.lang.IllegalArgumentException(
            "EnumValueDescriptor is not for this type.");
      ...
      private StringFilterPolicy(int value) {
        this.value = value;
      }

      // @@protoc_insertion_point(enum_scope:perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy)
    }

    public interface StringFilterRuleOrBuilder extends
        // @@protoc_insertion_point(interface_extends:perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)
        com.google.protobuf.MessageOrBuilder {
       ...
       * </pre>
       *
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy policy = 1;</code>
       ...
       * @return The policy.
       */
      perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy getPolicy();
       ...
       * </pre>
       *
       * <code>optional string regex_pattern = 2;</code>
       * @return Whether the regexPattern field is set.
       */
       ...
       *
       * <code>optional string regex_pattern = 2;</code>
       * @return The bytes for regexPattern.
       */
      com.google.protobuf.ByteString
          getRegexPatternBytes();
       ...
       * </pre>
       *
       * <code>optional string atrace_payload_starts_with = 3;</code>
       * @return Whether the atracePayloadStartsWith field is set.
       */
       ...
       *
       * <code>optional string atrace_payload_starts_with = 3;</code>
       * @return The atracePayloadStartsWith.
       */
      java.lang.String getAtracePayloadStartsWith();
      /**
       * <pre>
       * The string which should appear after the tgid in atrace tracepoint
       * strings.
       ...
       *
       * <code>optional string atrace_payload_starts_with = 3;</code>
       * @return The bytes for atracePayloadStartsWith.
       */
      com.google.protobuf.ByteString
          getAtracePayloadStartsWithBytes();
    }
    /**
     * <pre>
     ...
     * </pre>
     *
     * Protobuf type {@code perfetto.protos.TraceConfig.TraceFilter.StringFilterRule}
     */
    public static final class StringFilterRule extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)
        StringFilterRuleOrBuilder {
    private static final long serialVersionUID = 0L;
      // Use StringFilterRule.newBuilder() to construct.
      private StringFilterRule(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
        super(builder);
      }
      private StringFilterRule() {
        policy_ = 0;
        regexPattern_ = "";
        atracePayloadStartsWith_ = "";
      }
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterRule_descriptor;
      }

      @java.lang.Override
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterRule_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.class, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder.class);
      }
       ...
       * @return The policy.
       */
      @java.lang.Override public perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy getPolicy() {
        perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy result = perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy.forNumber(policy_);
        return result == null ? perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy.SFP_UNSPECIFIED : result;
      }

      public static final int REGEX_PATTERN_FIELD_NUMBER = 2;
      @SuppressWarnings("serial")
      private volatile java.lang.Object regexPattern_ = "";
      /**
       * <pre>
       * The regex pattern used to match against each string.
       * </pre>
      ...
      public java.lang.String getRegexPattern() {
        java.lang.Object ref = regexPattern_;
        if (ref instanceof java.lang.String) {
          return (java.lang.String) ref;
        } else {
          com.google.protobuf.ByteString bs = 
      ...
      @SuppressWarnings("serial")
      private volatile java.lang.Object atracePayloadStartsWith_ = "";
      /**
       * <pre>
       * The string which should appear after the tgid in atrace tracepoint
       * strings.
       ...
       */
      @java.lang.Override
      public java.lang.String getAtracePayloadStartsWith() {
        java.lang.Object ref = atracePayloadStartsWith_;
        if (ref instanceof java.lang.String) {
          return (java.lang.String) ref;
        } else {
          com.google.protobuf.ByteString bs = 
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (((bitField0_ & 0x00000002) != 0)) {
          com.google.protobuf.GeneratedMessageV3.writeString(output, 2, regexPattern_);
        }
        if (((bitField0_ & 0x00000004) != 0)) {
          com.google.protobuf.GeneratedMessageV3.writeString(output, 3, atracePayloadStartsWith_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000002) != 0)) {
          size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, regexPattern_);
        }
        if (((bitField0_ & 0x00000004) != 0)) {
          size += com.google.protobuf.GeneratedMessageV3.computeStringSize(3, atracePayloadStartsWith_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSize = size;
        return size;
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)) {
          return super.equals(obj);
        }
        perfetto.protos.TraceConfig.TraceFilter.StringFilterRule other = (perfetto.protos.TraceConfig.TraceFilter.StringFilterRule) obj;

        if (hasPolicy() != other.hasPolicy()) return false;
        if (hasPolicy()) {
          if (policy_ != other.policy_) return false;
        }
        if (hasRegexPattern() != other.hasRegexPattern()) return false;
        if (hasRegexPattern()) {
          if (!getRegexPattern()
              .equals(other.getRegexPattern())) return false;
        }
        if (hasAtracePayloadStartsWith() != other.hasAtracePayloadStartsWith()) return false;
        if (hasAtracePayloadStartsWith()) {
          if (!getAtracePayloadStartsWith()
              .equals(other.getAtracePayloadStartsWith())) return false;
        }
        if (!getUnknownFields().equals(other.getUnknownFields())) return false;
        return true;
      }
      ...
      public int hashCode() {
        ...
        if (hasRegexPattern()) {
          hash = (37 * hash) + REGEX_PATTERN_FIELD_NUMBER;
          hash = (53 * hash) + getRegexPattern().hashCode();
        }
        if (hasAtracePayloadStartsWith()) {
          hash = (37 * hash) + ATRACE_PAYLOAD_STARTS_WITH_FIELD_NUMBER;
          hash = (53 * hash) + getAtracePayloadStartsWith().hashCode();
        }
        hash = (29 * hash) + getUnknownFields().hashCode();
        memoizedHashCode = hash;
        return hash;
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseFrom(
          java.nio.ByteBuffer data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseFrom(
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(perfetto.protos.TraceConfig.TraceFilter.StringFilterRule prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      @java.lang.Override
      public Builder toBuilder() {
      ...
      public static final class Builder extends
          com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
          // @@protoc_insertion_point(builder_implements:perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)
          perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterRule_descriptor;
        }
        ...
        // Construct using perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule getDefaultInstanceForType() {
          return perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.getDefaultInstance();
        }

        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule build() {
          perfetto.protos.TraceConfig.TraceFilter.StringFilterRule result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule buildPartial() {
          perfetto.protos.TraceConfig.TraceFilter.StringFilterRule result = new perfetto.protos.TraceConfig.TraceFilter.StringFilterRule(this);
          if (bitField0_ != 0) { buildPartial0(result); }
          onBuilt();
          return result;
        }

        private void buildPartial0(perfetto.protos.TraceConfig.TraceFilter.StringFilterRule result) {
          int from_bitField0_ = bitField0_;
          int to_bitField0_ = 0;
          if (((from_bitField0_ & 0x00000001) != 0)) {
          ...
          if (((from_bitField0_ & 0x00000002) != 0)) {
            result.regexPattern_ = regexPattern_;
            to_bitField0_ |= 0x00000002;
          }
          if (((from_bitField0_ & 0x00000004) != 0)) {
            result.atracePayloadStartsWith_ = atracePayloadStartsWith_;
            to_bitField0_ |= 0x00000004;
          }
          result.bitField0_ |= to_bitField0_;
        }
        ...
        @java.lang.Override
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof perfetto.protos.TraceConfig.TraceFilter.StringFilterRule) {
            return mergeFrom((perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(perfetto.protos.TraceConfig.TraceFilter.StringFilterRule other) {
          if (other == perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.getDefaultInstance()) return this;
          if (other.hasPolicy()) {
            setPolicy(other.getPolicy());
          }
          if (other.hasRegexPattern()) {
            regexPattern_ = other.regexPattern_;
            bitField0_ |= 0x00000002;
            onChanged();
          }
          if (other.hasAtracePayloadStartsWith()) {
            atracePayloadStartsWith_ = other.atracePayloadStartsWith_;
            bitField0_ |= 0x00000004;
            onChanged();
          }
          this.mergeUnknownFields(other.getUnknownFields());
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 8: {
                  int tmpRaw = input.readEnum();
                  perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy tmpValue =
                      perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy.forNumber(tmpRaw);
                  if (tmpValue == null) {
                    mergeUnknownVarintField(1, tmpRaw);
                  } else {
                    policy_ = tmpRaw;
                ...
                case 18: {
                  regexPattern_ = input.readBytes();
                  bitField0_ |= 0x00000002;
                  break;
                } // case 18
                case 26: {
                  atracePayloadStartsWith_ = input.readBytes();
                  bitField0_ |= 0x00000004;
                  break;
                } // case 26
                default: {
         ...
         */
        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy getPolicy() {
          perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy result = perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy.forNumber(policy_);
          return result == null ? perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy.SFP_UNSPECIFIED : result;
        }
        /**
         ...
         * @return This builder for chaining.
         */
        public Builder setPolicy(perfetto.protos.TraceConfig.TraceFilter.StringFilterPolicy value) {
          if (value == null) {
            throw new NullPointerException();
          }
          bitField0_ |= 0x00000001;
        ...
        private java.lang.Object regexPattern_ = "";
        /**
         * <pre>
         * The regex pattern used to match against each string.
         * </pre>
        ...
        public Builder clearRegexPattern() {
          regexPattern_ = getDefaultInstance().getRegexPattern();
          bitField0_ = (bitField0_ & ~0x00000002);
          onChanged();
          return this;
        }
         ...
         *
         * <code>optional string regex_pattern = 2;</code>
         * @param value The bytes for regexPattern to set.
         * @return This builder for chaining.
         */
        public Builder setRegexPatternBytes(
            com.google.protobuf.ByteString value) {
          if (value == null) { throw new NullPointerException(); }
          regexPattern_ = value;
          bitField0_ |= 0x00000002;
        ...
        private java.lang.Object atracePayloadStartsWith_ = "";
        /**
         * <pre>
         * The string which should appear after the tgid in atrace tracepoint
         * strings.
         ...
         *
         * <code>optional string atrace_payload_starts_with = 3;</code>
         * @param value The atracePayloadStartsWith to set.
         * @return This builder for chaining.
         */
        public Builder setAtracePayloadStartsWith(
            java.lang.String value) {
          if (value == null) { throw new NullPointerException(); }
          atracePayloadStartsWith_ = value;
          bitField0_ |= 0x00000004;
          onChanged();
          return this;
        }
        ...
        public Builder clearAtracePayloadStartsWith() {
          atracePayloadStartsWith_ = getDefaultInstance().getAtracePayloadStartsWith();
          bitField0_ = (bitField0_ & ~0x00000004);
          onChanged();
          return this;
        }
         ...
         *
         * <code>optional string atrace_payload_starts_with = 3;</code>
         * @param value The bytes for atracePayloadStartsWith to set.
         * @return This builder for chaining.
         */
        public Builder setAtracePayloadStartsWithBytes(
            com.google.protobuf.ByteString value) {
          if (value == null) { throw new NullPointerException(); }
          atracePayloadStartsWith_ = value;
          bitField0_ |= 0x00000004;
        ...
        // @@protoc_insertion_point(builder_scope:perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)
      }

      // @@protoc_insertion_point(class_scope:perfetto.protos.TraceConfig.TraceFilter.StringFilterRule)
      private static final perfetto.protos.TraceConfig.TraceFilter.StringFilterRule DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.TraceFilter.StringFilterRule();
      }

      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterRule getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }

      @java.lang.Deprecated public static final com.google.protobuf.Parser<StringFilterRule>
          PARSER = new com.google.protobuf.AbstractParser<StringFilterRule>() {
        @java.lang.Override
        public StringFilterRule parsePartialFrom(
            com.google.protobuf.CodedInputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          Builder builder = newBuilder();
      ...
      public static com.google.protobuf.Parser<StringFilterRule> parser() {
        return PARSER;
      }

      @java.lang.Override
      public com.google.protobuf.Parser<StringFilterRule> getParserForType() {
        return PARSER;
      }
    ...
    public interface StringFilterChainOrBuilder extends
        // @@protoc_insertion_point(interface_extends:perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)
        com.google.protobuf.MessageOrBuilder {

      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      java.util.List<perfetto.protos.TraceConfig.TraceFilter.StringFilterRule> 
          getRulesList();
      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      perfetto.protos.TraceConfig.TraceFilter.StringFilterRule getRules(int index);
      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      int getRulesCount();
       ...
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      java.util.List<? extends perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder> 
          getRulesOrBuilderList();
      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder getRulesOrBuilder(
          int index);
    }
    /**
     * <pre>
     ...
     * </pre>
     *
     * Protobuf type {@code perfetto.protos.TraceConfig.TraceFilter.StringFilterChain}
     */
    public static final class StringFilterChain extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)
        StringFilterChainOrBuilder {
    private static final long serialVersionUID = 0L;
      // Use StringFilterChain.newBuilder() to construct.
      private StringFilterChain(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
        super(builder);
      }
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterChain_descriptor;
      }

      @java.lang.Override
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterChain_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.class, perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder.class);
      }

      public static final int RULES_FIELD_NUMBER = 1;
      @SuppressWarnings("serial")
      private java.util.List<perfetto.protos.TraceConfig.TraceFilter.StringFilterRule> rules_;
      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      @java.lang.Override
      public java.util.List<perfetto.protos.TraceConfig.TraceFilter.StringFilterRule> getRulesList() {
        return rules_;
      }
      /**
       * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
       */
      @java.lang.Override
      public java.util.List<? extends perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder> 
          getRulesOrBuilderList() {
        return rules_;
      }
      /**
       ...
       */
      @java.lang.Override
      public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule getRules(int index) {
       ...
       */
      @java.lang.Override
      public perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder getRulesOrBuilder(
          int index) {
        return rules_.get(index);
      }
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)) {
          return super.equals(obj);
        }
        perfetto.protos.TraceConfig.TraceFilter.StringFilterChain other = (perfetto.protos.TraceConfig.TraceFilter.StringFilterChain) obj;
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseFrom(
          java.nio.ByteBuffer data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseFrom(
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      @java.lang.Override
      public Builder toBuilder() {
      ...
      public static final class Builder extends
          com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
          // @@protoc_insertion_point(builder_implements:perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_StringFilterChain_descriptor;
        }
        ...
        // Construct using perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain getDefaultInstanceForType() {
          return perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance();
        }

        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain build() {
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChain result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        @java.lang.Override
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain buildPartial() {
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChain result = new perfetto.protos.TraceConfig.TraceFilter.StringFilterChain(this);
          buildPartialRepeatedFields(result);
          if (bitField0_ != 0) { buildPartial0(result); }
          onBuilt();
          return result;
        ...
        private void buildPartialRepeatedFields(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain result) {
          if (rulesBuilder_ == null) {
            if (((bitField0_ & 0x00000001) != 0)) {
        ...
        private void buildPartial0(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain result) {
          int from_bitField0_ = bitField0_;
        }
        ...
        @java.lang.Override
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof perfetto.protos.TraceConfig.TraceFilter.StringFilterChain) {
            return mergeFrom((perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain other) {
          if (other == perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance()) return this;
          if (rulesBuilder_ == null) {
            ...
            while (!done) {
              ...
              switch (tag) {
                case 0:
                  ...
                  break;
                case 10: {
                  perfetto.protos.TraceConfig.TraceFilter.StringFilterRule m =
                      input.readMessage(
                          perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.PARSER,
                          extensionRegistry);
                  if (rulesBuilder_ == null) {
                    ensureRulesIsMutable();
                    rules_.add(m);
        ...
        private void ensureRulesIsMutable() {
          if (!((bitField0_ & 0x00000001) != 0)) {
            rules_ = new java.util.ArrayList<perfetto.protos.TraceConfig.TraceFilter.StringFilterRule>(rules_);
            bitField0_ |= 0x00000001;
           }
        }

        private com.google.protobuf.RepeatedFieldBuilderV3<
            perfetto.protos.TraceConfig.TraceFilter.StringFilterRule, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder, perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder> rulesBuilder_;
        ...
        public Builder setRules(
            int index, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule value) {
          if (rulesBuilder_ == null) {
            if (value == null) {
              throw new NullPointerException();
            }
         ...
         */
        public Builder setRules(
            int index, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder builderForValue) {
          if (rulesBuilder_ == null) {
            ensureRulesIsMutable();
         ...
         * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
         */
        public Builder addRules(perfetto.protos.TraceConfig.TraceFilter.StringFilterRule value) {
          if (rulesBuilder_ == null) {
            if (value == null) {
              throw new NullPointerException();
            }
         ...
         */
        public Builder addRules(
            perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder builderForValue) {
          if (rulesBuilder_ == null) {
            ensureRulesIsMutable();
        ...
        public Builder addAllRules(
            java.lang.Iterable<? extends perfetto.protos.TraceConfig.TraceFilter.StringFilterRule> values) {
          if (rulesBuilder_ == null) {
            ensureRulesIsMutable();
            com.google.protobuf.AbstractMessageLite.Builder.addAll(
                values, rules_);
         ...
         * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
         */
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder getRulesBuilder(
            int index) {
         ...
         * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
         */
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder addRulesBuilder() {
          return getRulesFieldBuilder().addBuilder(
              perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.getDefaultInstance());
        }
        /**
         * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
         */
        public perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder addRulesBuilder(
            int index) {
          return getRulesFieldBuilder().addBuilder(
              index, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.getDefaultInstance());
        }
        /**
         * <code>repeated .perfetto.protos.TraceConfig.TraceFilter.StringFilterRule rules = 1;</code>
         */
        public java.util.List<perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder> 
             getRulesBuilderList() {
          return getRulesFieldBuilder().getBuilderList();
        }
        private com.google.protobuf.RepeatedFieldBuilderV3<
            perfetto.protos.TraceConfig.TraceFilter.StringFilterRule, perfetto.protos.TraceConfig.TraceFilter.StringFilterRule.Builder, perfetto.protos.TraceConfig.TraceFilter.StringFilterRuleOrBuilder> 
        ...
        // @@protoc_insertion_point(builder_scope:perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)
      }

      // @@protoc_insertion_point(class_scope:perfetto.protos.TraceConfig.TraceFilter.StringFilterChain)
      private static final perfetto.protos.TraceConfig.TraceFilter.StringFilterChain DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.TraceFilter.StringFilterChain();
      }

      public static perfetto.protos.TraceConfig.TraceFilter.StringFilterChain getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }

      @java.lang.Deprecated public static final com.google.protobuf.Parser<StringFilterChain>
          PARSER = new com.google.protobuf.AbstractParser<StringFilterChain>() {
        @java.lang.Override
        public StringFilterChain parsePartialFrom(
            com.google.protobuf.CodedInputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          Builder builder = newBuilder();
      ...
      public static com.google.protobuf.Parser<StringFilterChain> parser() {
        return PARSER;
      }

      @java.lang.Override
      public com.google.protobuf.Parser<StringFilterChain> getParserForType() {
        return PARSER;
      }
    ...
    private com.google.protobuf.ByteString bytecodeV2_ = com.google.protobuf.ByteString.EMPTY;
    /**
     * <pre>
     * The bytecode as implemented in Android U. Adds support for string
     * filtering.
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getBytecodeV2() {
      return bytecodeV2_;
    }

    public static final int STRING_FILTER_CHAIN_FIELD_NUMBER = 3;
    private perfetto.protos.TraceConfig.TraceFilter.StringFilterChain stringFilterChain_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
     * @return Whether the stringFilterChain field is set.
     */
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain getStringFilterChain() {
      return stringFilterChain_ == null ? perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance() : stringFilterChain_;
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder getStringFilterChainOrBuilder() {
      return stringFilterChain_ == null ? perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance() : stringFilterChain_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        output.writeBytes(2, bytecodeV2_);
      }
      if (((bitField0_ & 0x00000004) != 0)) {
        output.writeMessage(3, getStringFilterChain());
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(2, bytecodeV2_);
      }
      if (((bitField0_ & 0x00000004) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getStringFilterChain());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.TraceFilter)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.TraceFilter other = (perfetto.protos.TraceConfig.TraceFilter) obj;
      ...
      if (hasBytecodeV2() != other.hasBytecodeV2()) return false;
      if (hasBytecodeV2()) {
        if (!getBytecodeV2()
            .equals(other.getBytecodeV2())) return false;
      }
      if (hasStringFilterChain() != other.hasStringFilterChain()) return false;
      if (hasStringFilterChain()) {
        if (!getStringFilterChain()
            .equals(other.getStringFilterChain())) return false;
      }
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      if (hasBytecodeV2()) {
        hash = (37 * hash) + BYTECODE_V2_FIELD_NUMBER;
        hash = (53 * hash) + getBytecodeV2().hashCode();
      }
      if (hasStringFilterChain()) {
        hash = (37 * hash) + STRING_FILTER_CHAIN_FIELD_NUMBER;
        hash = (53 * hash) + getStringFilterChain().hashCode();
      }
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static perfetto.protos.TraceConfig.TraceFilter parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.TraceFilter parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.TraceFilter parseFrom(
    ...
    public static perfetto.protos.TraceConfig.TraceFilter parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.TraceFilter parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.TraceFilter parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.TraceFilter prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.TraceFilterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_TraceFilter_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.TraceFilter.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Builder clear() {
        ...
        bytecode_ = com.google.protobuf.ByteString.EMPTY;
        bytecodeV2_ = com.google.protobuf.ByteString.EMPTY;
        stringFilterChain_ = null;
        if (stringFilterChainBuilder_ != null) {
          stringFilterChainBuilder_.dispose();
          stringFilterChainBuilder_ = null;
        }
        return this;
      }
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.TraceFilter getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.TraceFilter build() {
        perfetto.protos.TraceConfig.TraceFilter result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.TraceFilter buildPartial() {
        perfetto.protos.TraceConfig.TraceFilter result = new perfetto.protos.TraceConfig.TraceFilter(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.TraceFilter result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          result.bytecodeV2_ = bytecodeV2_;
          to_bitField0_ |= 0x00000002;
        }
        if (((from_bitField0_ & 0x00000004) != 0)) {
          result.stringFilterChain_ = stringFilterChainBuilder_ == null
              ? stringFilterChain_
              : stringFilterChainBuilder_.build();
          to_bitField0_ |= 0x00000004;
        }
        result.bitField0_ |= to_bitField0_;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.TraceFilter) {
          return mergeFrom((perfetto.protos.TraceConfig.TraceFilter)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.TraceFilter other) {
        if (other == perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance()) return this;
        if (other.hasBytecode()) {
          setBytecode(other.getBytecode());
        }
        if (other.hasBytecodeV2()) {
          setBytecodeV2(other.getBytecodeV2());
        }
        if (other.hasStringFilterChain()) {
          mergeStringFilterChain(other.getStringFilterChain());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                bytecodeV2_ = input.readBytes();
                bitField0_ |= 0x00000002;
                break;
              } // case 18
              case 26: {
                input.readMessage(
                    getStringFilterChainFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case 26
       ...
       *
       * <code>optional bytes bytecode_v2 = 2;</code>
       * @param value The bytecodeV2 to set.
       * @return This builder for chaining.
       */
      public Builder setBytecodeV2(com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        bytecodeV2_ = value;
        bitField0_ |= 0x00000002;
        onChanged();
      ...
      public Builder clearBytecodeV2() {
        bitField0_ = (bitField0_ & ~0x00000002);
        bytecodeV2_ = getDefaultInstance().getBytecodeV2();
        onChanged();
        return this;
      }
      ...
      private perfetto.protos.TraceConfig.TraceFilter.StringFilterChain stringFilterChain_;
      private com.google.protobuf.SingleFieldBuilderV3<
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChain, perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder, perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder> stringFilterChainBuilder_;
      /**
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       * @return Whether the stringFilterChain field is set.
       */
      ...
      public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain getStringFilterChain() {
        if (stringFilterChainBuilder_ == null) {
          ...
          return stringFilterChainBuilder_.getMessage();
        }
      }
      /**
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       */
      public Builder setStringFilterChain(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain value) {
        if (stringFilterChainBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          stringFilterChain_ = value;
        } else {
          stringFilterChainBuilder_.setMessage(value);
        }
        bitField0_ |= 0x00000004;
        onChanged();
        return this;
       ...
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       */
      public Builder setStringFilterChain(
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder builderForValue) {
        if (stringFilterChainBuilder_ == null) {
          stringFilterChain_ = builderForValue.build();
        } else {
          stringFilterChainBuilder_.setMessage(builderForValue.build());
        }
        bitField0_ |= 0x00000004;
        onChanged();
        return this;
       ...
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       */
      public Builder mergeStringFilterChain(perfetto.protos.TraceConfig.TraceFilter.StringFilterChain value) {
        if (stringFilterChainBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            stringFilterChain_ != null &&
            stringFilterChain_ != perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance()) {
            getStringFilterChainBuilder().mergeFrom(value);
          } else {
            stringFilterChain_ = value;
          }
        } else {
          stringFilterChainBuilder_.mergeFrom(value);
        }
        bitField0_ |= 0x00000004;
        onChanged();
        return this;
       ...
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       */
      public perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder getStringFilterChainBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
      ...
      public perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder getStringFilterChainOrBuilder() {
        if (stringFilterChainBuilder_ != null) {
          return stringFilterChainBuilder_.getMessageOrBuilder();
        } else {
          return stringFilterChain_ == null ?
              perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.getDefaultInstance() : stringFilterChain_;
        }
      }
      /**
       * <code>optional .perfetto.protos.TraceConfig.TraceFilter.StringFilterChain string_filter_chain = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          perfetto.protos.TraceConfig.TraceFilter.StringFilterChain, perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder, perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder> 
          getStringFilterChainFieldBuilder() {
        if (stringFilterChainBuilder_ == null) {
          stringFilterChainBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              perfetto.protos.TraceConfig.TraceFilter.StringFilterChain, perfetto.protos.TraceConfig.TraceFilter.StringFilterChain.Builder, perfetto.protos.TraceConfig.TraceFilter.StringFilterChainOrBuilder>(
                  getStringFilterChain(),
                  getParentForChildren(),
                  isClean());
          stringFilterChain_ = null;
        }
        return stringFilterChainBuilder_;
      }
      @java.lang.Override
      public final Builder setUnknownFields(
          final com.google.protobuf.UnknownFieldSet unknownFields) {
    ...
    private static final perfetto.protos.TraceConfig.TraceFilter DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.TraceFilter();
    }

    public static perfetto.protos.TraceConfig.TraceFilter getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_AndroidReportConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_AndroidReportConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.AndroidReportConfig.class, perfetto.protos.TraceConfig.AndroidReportConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.AndroidReportConfig)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.AndroidReportConfig other = (perfetto.protos.TraceConfig.AndroidReportConfig) obj;
    ...
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseFrom(
    ...
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.AndroidReportConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.AndroidReportConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.AndroidReportConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_AndroidReportConfig_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.AndroidReportConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.AndroidReportConfig getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.AndroidReportConfig build() {
        perfetto.protos.TraceConfig.AndroidReportConfig result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.AndroidReportConfig buildPartial() {
        perfetto.protos.TraceConfig.AndroidReportConfig result = new perfetto.protos.TraceConfig.AndroidReportConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.AndroidReportConfig result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.AndroidReportConfig) {
          return mergeFrom((perfetto.protos.TraceConfig.AndroidReportConfig)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.AndroidReportConfig other) {
        if (other == perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.AndroidReportConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.AndroidReportConfig();
    }

    public static perfetto.protos.TraceConfig.AndroidReportConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_CmdTraceStartDelay_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_CmdTraceStartDelay_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.CmdTraceStartDelay.class, perfetto.protos.TraceConfig.CmdTraceStartDelay.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.CmdTraceStartDelay)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.CmdTraceStartDelay other = (perfetto.protos.TraceConfig.CmdTraceStartDelay) obj;
    ...
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseFrom(
    ...
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.CmdTraceStartDelay parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.CmdTraceStartDelay prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        perfetto.protos.TraceConfig.CmdTraceStartDelayOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_CmdTraceStartDelay_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.CmdTraceStartDelay.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.CmdTraceStartDelay getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.CmdTraceStartDelay build() {
        perfetto.protos.TraceConfig.CmdTraceStartDelay result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.CmdTraceStartDelay buildPartial() {
        perfetto.protos.TraceConfig.CmdTraceStartDelay result = new perfetto.protos.TraceConfig.CmdTraceStartDelay(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.CmdTraceStartDelay result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.CmdTraceStartDelay) {
          return mergeFrom((perfetto.protos.TraceConfig.CmdTraceStartDelay)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.CmdTraceStartDelay other) {
        if (other == perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance()) return this;
    ...
    private static final perfetto.protos.TraceConfig.CmdTraceStartDelay DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.CmdTraceStartDelay();
    }

    public static perfetto.protos.TraceConfig.CmdTraceStartDelay getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface SessionSemaphoreOrBuilder extends
      // @@protoc_insertion_point(interface_extends:perfetto.protos.TraceConfig.SessionSemaphore)
      com.google.protobuf.MessageOrBuilder {
     ...
     * </pre>
     *
     * <code>optional uint64 max_other_session_count = 2;</code>
     * @return Whether the maxOtherSessionCount field is set.
     */
     ...
     *
     * <code>optional uint64 max_other_session_count = 2;</code>
     * @return The maxOtherSessionCount.
     */
   ...
   * </pre>
   *
   * Protobuf type {@code perfetto.protos.TraceConfig.SessionSemaphore}
   */
  public static final class SessionSemaphore extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:perfetto.protos.TraceConfig.SessionSemaphore)
      SessionSemaphoreOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use SessionSemaphore.newBuilder() to construct.
    private SessionSemaphore(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_SessionSemaphore_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_SessionSemaphore_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              perfetto.protos.TraceConfig.SessionSemaphore.class, perfetto.protos.TraceConfig.SessionSemaphore.Builder.class);
    }
    ...
    private long maxOtherSessionCount_ = 0L;
    /**
     * <pre>
     * The maximum number of *other* sesssions which specify the same semaphore
     * which can be active. The minimum of this value across all tracing
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        output.writeUInt64(2, maxOtherSessionCount_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(2, maxOtherSessionCount_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof perfetto.protos.TraceConfig.SessionSemaphore)) {
        return super.equals(obj);
      }
      perfetto.protos.TraceConfig.SessionSemaphore other = (perfetto.protos.TraceConfig.SessionSemaphore) obj;
      ...
      if (hasMaxOtherSessionCount() != other.hasMaxOtherSessionCount()) return false;
      if (hasMaxOtherSessionCount()) {
        if (getMaxOtherSessionCount()
            != other.getMaxOtherSessionCount()) return false;
      }
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      if (hasMaxOtherSessionCount()) {
        hash = (37 * hash) + MAX_OTHER_SESSION_COUNT_FIELD_NUMBER;
        hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
            getMaxOtherSessionCount());
      }
      hash = (29 * hash) + getUnknownFields().hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static perfetto.protos.TraceConfig.SessionSemaphore parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static perfetto.protos.TraceConfig.SessionSemaphore parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static perfetto.protos.TraceConfig.SessionSemaphore parseFrom(
    ...
    public static perfetto.protos.TraceConfig.SessionSemaphore parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static perfetto.protos.TraceConfig.SessionSemaphore parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static perfetto.protos.TraceConfig.SessionSemaphore parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(perfetto.protos.TraceConfig.SessionSemaphore prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:perfetto.protos.TraceConfig.SessionSemaphore)
        perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_SessionSemaphore_descriptor;
      }
      ...
      // Construct using perfetto.protos.TraceConfig.SessionSemaphore.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.SessionSemaphore getDefaultInstanceForType() {
        return perfetto.protos.TraceConfig.SessionSemaphore.getDefaultInstance();
      }

      @java.lang.Override
      public perfetto.protos.TraceConfig.SessionSemaphore build() {
        perfetto.protos.TraceConfig.SessionSemaphore result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public perfetto.protos.TraceConfig.SessionSemaphore buildPartial() {
        perfetto.protos.TraceConfig.SessionSemaphore result = new perfetto.protos.TraceConfig.SessionSemaphore(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(perfetto.protos.TraceConfig.SessionSemaphore result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.name_ = name_;
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          result.maxOtherSessionCount_ = maxOtherSessionCount_;
          to_bitField0_ |= 0x00000002;
        }
        result.bitField0_ |= to_bitField0_;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof perfetto.protos.TraceConfig.SessionSemaphore) {
          return mergeFrom((perfetto.protos.TraceConfig.SessionSemaphore)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(perfetto.protos.TraceConfig.SessionSemaphore other) {
        if (other == perfetto.protos.TraceConfig.SessionSemaphore.getDefaultInstance()) return this;
        if (other.hasName()) {
          name_ = other.name_;
          bitField0_ |= 0x00000001;
          onChanged();
        }
        if (other.hasMaxOtherSessionCount()) {
          setMaxOtherSessionCount(other.getMaxOtherSessionCount());
        }
        this.mergeUnknownFields(other.getUnknownFields());
        onChanged();
        return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 16: {
                maxOtherSessionCount_ = input.readUInt64();
                bitField0_ |= 0x00000002;
                break;
              } // case 16
              default: {
       ...
       *
       * <code>optional uint64 max_other_session_count = 2;</code>
       * @param value The maxOtherSessionCount to set.
       * @return This builder for chaining.
       */
      public Builder setMaxOtherSessionCount(long value) {
        
        maxOtherSessionCount_ = value;
        bitField0_ |= 0x00000002;
        onChanged();
        return this;
      }
      ...
      // @@protoc_insertion_point(builder_scope:perfetto.protos.TraceConfig.SessionSemaphore)
    }

    // @@protoc_insertion_point(class_scope:perfetto.protos.TraceConfig.SessionSemaphore)
    private static final perfetto.protos.TraceConfig.SessionSemaphore DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new perfetto.protos.TraceConfig.SessionSemaphore();
    }

    public static perfetto.protos.TraceConfig.SessionSemaphore getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    @java.lang.Deprecated public static final com.google.protobuf.Parser<SessionSemaphore>
        PARSER = new com.google.protobuf.AbstractParser<SessionSemaphore>() {
      @java.lang.Override
      public SessionSemaphore parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        Builder builder = newBuilder();
    ...
    public static com.google.protobuf.Parser<SessionSemaphore> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<SessionSemaphore> getParserForType() {
      return PARSER;
    }
  ...
  @SuppressWarnings("serial")
  private java.util.List<perfetto.protos.TraceConfig.BufferConfig> buffers_;
  /**
   * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
   */
  @java.lang.Override
  public java.util.List<perfetto.protos.TraceConfig.BufferConfig> getBuffersList() {
    return buffers_;
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
   */
  @java.lang.Override
  public java.util.List<? extends perfetto.protos.TraceConfig.BufferConfigOrBuilder> 
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.BufferConfig getBuffers(int index) {
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.BufferConfigOrBuilder getBuffersOrBuilder(
      int index) {
    return buffers_.get(index);
  }
  ...
  @SuppressWarnings("serial")
  private java.util.List<perfetto.protos.TraceConfig.DataSource> dataSources_;
  /**
   * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
   */
  @java.lang.Override
  public java.util.List<perfetto.protos.TraceConfig.DataSource> getDataSourcesList() {
    return dataSources_;
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
   */
  @java.lang.Override
  public java.util.List<? extends perfetto.protos.TraceConfig.DataSourceOrBuilder> 
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.DataSource getDataSources(int index) {
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.DataSourceOrBuilder getDataSourcesOrBuilder(
      int index) {
    return dataSources_.get(index);
  }

  public static final int BUILTIN_DATA_SOURCES_FIELD_NUMBER = 20;
  private perfetto.protos.TraceConfig.BuiltinDataSource builtinDataSources_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.BuiltinDataSource getBuiltinDataSources() {
    return builtinDataSources_ == null ? perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance() : builtinDataSources_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.BuiltinDataSourceOrBuilder getBuiltinDataSourcesOrBuilder() {
    return builtinDataSources_ == null ? perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance() : builtinDataSources_;
  }
   ...
   */
  @java.lang.Override public perfetto.protos.TraceConfig.LockdownModeOperation getLockdownMode() {
    perfetto.protos.TraceConfig.LockdownModeOperation result = perfetto.protos.TraceConfig.LockdownModeOperation.forNumber(lockdownMode_);
    return result == null ? perfetto.protos.TraceConfig.LockdownModeOperation.LOCKDOWN_UNCHANGED : result;
  }

  public static final int PRODUCERS_FIELD_NUMBER = 6;
  @SuppressWarnings("serial")
  private java.util.List<perfetto.protos.TraceConfig.ProducerConfig> producers_;
  /**
   * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
   */
  @java.lang.Override
  public java.util.List<perfetto.protos.TraceConfig.ProducerConfig> getProducersList() {
    return producers_;
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
   */
  @java.lang.Override
  public java.util.List<? extends perfetto.protos.TraceConfig.ProducerConfigOrBuilder> 
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.ProducerConfig getProducers(int index) {
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.ProducerConfigOrBuilder getProducersOrBuilder(
      int index) {
    return producers_.get(index);
  }

  public static final int STATSD_METADATA_FIELD_NUMBER = 7;
  private perfetto.protos.TraceConfig.StatsdMetadata statsdMetadata_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.StatsdMetadata getStatsdMetadata() {
    return statsdMetadata_ == null ? perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance() : statsdMetadata_;
  }
  /**
   * <pre>
   * Statsd-specific metadata.
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.StatsdMetadataOrBuilder getStatsdMetadataOrBuilder() {
    return statsdMetadata_ == null ? perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance() : statsdMetadata_;
  }
  ...
  private perfetto.protos.TraceConfig.GuardrailOverrides guardrailOverrides_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.GuardrailOverrides getGuardrailOverrides() {
    return guardrailOverrides_ == null ? perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance() : guardrailOverrides_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.GuardrailOverridesOrBuilder getGuardrailOverridesOrBuilder() {
    return guardrailOverrides_ == null ? perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance() : guardrailOverrides_;
  }
  ...
  private perfetto.protos.TraceConfig.TriggerConfig triggerConfig_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.TriggerConfig getTriggerConfig() {
    return triggerConfig_ == null ? perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance() : triggerConfig_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.TriggerConfigOrBuilder getTriggerConfigOrBuilder() {
    return triggerConfig_ == null ? perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance() : triggerConfig_;
  }
  ...
  private perfetto.protos.TraceConfig.IncrementalStateConfig incrementalStateConfig_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.IncrementalStateConfig getIncrementalStateConfig() {
    return incrementalStateConfig_ == null ? perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance() : incrementalStateConfig_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.IncrementalStateConfigOrBuilder getIncrementalStateConfigOrBuilder() {
    return incrementalStateConfig_ == null ? perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance() : incrementalStateConfig_;
  }
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public boolean hasAllowUserBuildTracing() {
   ...
   */
  @java.lang.Override
  @java.lang.Deprecated public boolean getAllowUserBuildTracing() {
   ...
   */
  @java.lang.Override public perfetto.protos.TraceConfig.CompressionType getCompressionType() {
    perfetto.protos.TraceConfig.CompressionType result = perfetto.protos.TraceConfig.CompressionType.forNumber(compressionType_);
    return result == null ? perfetto.protos.TraceConfig.CompressionType.COMPRESSION_TYPE_UNSPECIFIED : result;
  }

  public static final int INCIDENT_REPORT_CONFIG_FIELD_NUMBER = 25;
  private perfetto.protos.TraceConfig.IncidentReportConfig incidentReportConfig_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.IncidentReportConfig getIncidentReportConfig() {
    return incidentReportConfig_ == null ? perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance() : incidentReportConfig_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.IncidentReportConfigOrBuilder getIncidentReportConfigOrBuilder() {
    return incidentReportConfig_ == null ? perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance() : incidentReportConfig_;
  }
   ...
   */
  @java.lang.Override public perfetto.protos.TraceConfig.StatsdLogging getStatsdLogging() {
    perfetto.protos.TraceConfig.StatsdLogging result = perfetto.protos.TraceConfig.StatsdLogging.forNumber(statsdLogging_);
    return result == null ? perfetto.protos.TraceConfig.StatsdLogging.STATSD_LOGGING_UNSPECIFIED : result;
  }
  ...
  private perfetto.protos.TraceConfig.TraceFilter traceFilter_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.TraceFilter getTraceFilter() {
    return traceFilter_ == null ? perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance() : traceFilter_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.TraceFilterOrBuilder getTraceFilterOrBuilder() {
    return traceFilter_ == null ? perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance() : traceFilter_;
  }

  public static final int ANDROID_REPORT_CONFIG_FIELD_NUMBER = 34;
  private perfetto.protos.TraceConfig.AndroidReportConfig androidReportConfig_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.AndroidReportConfig getAndroidReportConfig() {
    return androidReportConfig_ == null ? perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance() : androidReportConfig_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.AndroidReportConfigOrBuilder getAndroidReportConfigOrBuilder() {
    return androidReportConfig_ == null ? perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance() : androidReportConfig_;
  }

  public static final int CMD_TRACE_START_DELAY_FIELD_NUMBER = 35;
  private perfetto.protos.TraceConfig.CmdTraceStartDelay cmdTraceStartDelay_;
  /**
   ...
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.CmdTraceStartDelay getCmdTraceStartDelay() {
    return cmdTraceStartDelay_ == null ? perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance() : cmdTraceStartDelay_;
  }
  /**
   * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.CmdTraceStartDelayOrBuilder getCmdTraceStartDelayOrBuilder() {
    return cmdTraceStartDelay_ == null ? perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance() : cmdTraceStartDelay_;
  }

  public static final int SESSION_SEMAPHORES_FIELD_NUMBER = 39;
  @SuppressWarnings("serial")
  private java.util.List<perfetto.protos.TraceConfig.SessionSemaphore> sessionSemaphores_;
  /**
   * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
   */
  @java.lang.Override
  public java.util.List<perfetto.protos.TraceConfig.SessionSemaphore> getSessionSemaphoresList() {
    return sessionSemaphores_;
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
   */
  @java.lang.Override
  public java.util.List<? extends perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder> 
  ...
  public int getSessionSemaphoresCount() {
    return sessionSemaphores_.size();
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.SessionSemaphore getSessionSemaphores(int index) {
    return sessionSemaphores_.get(index);
  }
  /**
   * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
   */
  @java.lang.Override
  public perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder getSessionSemaphoresOrBuilder(
      int index) {
    return sessionSemaphores_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (((bitField0_ & 0x00000004) != 0)) {
      output.writeBool(36, preferSuspendClockForDuration_);
    }
    if (((bitField0_ & 0x00020000) != 0)) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 38, bugreportFilename_);
    }
    for (int i = 0; i < sessionSemaphores_.size(); i++) {
      output.writeMessage(39, sessionSemaphores_.get(i));
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000004) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(36, preferSuspendClockForDuration_);
    }
    if (((bitField0_ & 0x00020000) != 0)) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(38, bugreportFilename_);
    }
    for (int i = 0; i < sessionSemaphores_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(39, sessionSemaphores_.get(i));
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof perfetto.protos.TraceConfig)) {
      return super.equals(obj);
    }
    perfetto.protos.TraceConfig other = (perfetto.protos.TraceConfig) obj;
    ...
    if (!getSessionSemaphoresList()
        .equals(other.getSessionSemaphoresList())) return false;
    if (!getUnknownFields().equals(other.getUnknownFields())) return false;
    return true;
  }
  ...
  public int hashCode() {
    ...
    if (getSessionSemaphoresCount() > 0) {
      hash = (37 * hash) + SESSION_SEMAPHORES_FIELD_NUMBER;
      hash = (53 * hash) + getSessionSemaphoresList().hashCode();
    }
    hash = (29 * hash) + getUnknownFields().hashCode();
    memoizedHashCode = hash;
    return hash;
  ...
  public static perfetto.protos.TraceConfig parseFrom(
      java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static perfetto.protos.TraceConfig parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static perfetto.protos.TraceConfig parseFrom(
  ...
  public static perfetto.protos.TraceConfig parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseWithIOException(PARSER, input);
  }
  ...
  public static perfetto.protos.TraceConfig parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static perfetto.protos.TraceConfig parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(perfetto.protos.TraceConfig prototype) {
    return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
  }
  @java.lang.Override
  public Builder toBuilder() {
  ...
  public static final class Builder extends
      ...
      perfetto.protos.TraceConfigOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_TraceConfig_descriptor;
    }
    ...
    // Construct using perfetto.protos.TraceConfig.newBuilder()
    private Builder() {
      maybeForceBuilderInitialization();
    }
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessageV3
        ...
        getSessionSemaphoresFieldBuilder();
      }
    }
    @java.lang.Override
    public Builder clear() {
      ...
      if (sessionSemaphoresBuilder_ == null) {
        sessionSemaphores_ = java.util.Collections.emptyList();
      } else {
        sessionSemaphores_ = null;
        sessionSemaphoresBuilder_.clear();
      }
    ...
    @java.lang.Override
    public perfetto.protos.TraceConfig getDefaultInstanceForType() {
      return perfetto.protos.TraceConfig.getDefaultInstance();
    }

    @java.lang.Override
    public perfetto.protos.TraceConfig build() {
      perfetto.protos.TraceConfig result = buildPartial();
      if (!result.isInitialized()) {
        throw newUninitializedMessageException(result);
      }
      return result;
    ...
    @java.lang.Override
    public perfetto.protos.TraceConfig buildPartial() {
      perfetto.protos.TraceConfig result = new perfetto.protos.TraceConfig(this);
      buildPartialRepeatedFields(result);
      if (bitField0_ != 0) { buildPartial0(result); }
    ...
    private void buildPartialRepeatedFields(perfetto.protos.TraceConfig result) {
      if (buffersBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
      ...
      if (sessionSemaphoresBuilder_ == null) {
        if (((bitField1_ & 0x00000004) != 0)) {
          sessionSemaphores_ = java.util.Collections.unmodifiableList(sessionSemaphores_);
          bitField1_ = (bitField1_ & ~0x00000004);
        }
        result.sessionSemaphores_ = sessionSemaphores_;
      } else {
        result.sessionSemaphores_ = sessionSemaphoresBuilder_.build();
      }
    }

    private void buildPartial0(perfetto.protos.TraceConfig result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000004) != 0)) {
    ...
    private void buildPartial1(perfetto.protos.TraceConfig result) {
    ...
    @java.lang.Override
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof perfetto.protos.TraceConfig) {
        return mergeFrom((perfetto.protos.TraceConfig)other);
      } else {
        super.mergeFrom(other);
        return this;
      }
    ...
    public Builder mergeFrom(perfetto.protos.TraceConfig other) {
      if (other == perfetto.protos.TraceConfig.getDefaultInstance()) return this;
      if (buffersBuilder_ == null) {
      ...
      if (sessionSemaphoresBuilder_ == null) {
        if (!other.sessionSemaphores_.isEmpty()) {
          if (sessionSemaphores_.isEmpty()) {
            sessionSemaphores_ = other.sessionSemaphores_;
            bitField1_ = (bitField1_ & ~0x00000004);
          } else {
            ensureSessionSemaphoresIsMutable();
            sessionSemaphores_.addAll(other.sessionSemaphores_);
          }
          onChanged();
        }
      } else {
        if (!other.sessionSemaphores_.isEmpty()) {
          if (sessionSemaphoresBuilder_.isEmpty()) {
            sessionSemaphoresBuilder_.dispose();
            sessionSemaphoresBuilder_ = null;
            sessionSemaphores_ = other.sessionSemaphores_;
            bitField1_ = (bitField1_ & ~0x00000004);
            sessionSemaphoresBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getSessionSemaphoresFieldBuilder() : null;
          } else {
            sessionSemaphoresBuilder_.addAllMessages(other.sessionSemaphores_);
          }
        }
      }
      this.mergeUnknownFields(other.getUnknownFields());
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              perfetto.protos.TraceConfig.BufferConfig m =
                  input.readMessage(
                      perfetto.protos.TraceConfig.BufferConfig.PARSER,
                      extensionRegistry);
              if (buffersBuilder_ == null) {
                ensureBuffersIsMutable();
                buffers_.add(m);
            ...
            case 18: {
              perfetto.protos.TraceConfig.DataSource m =
                  input.readMessage(
                      perfetto.protos.TraceConfig.DataSource.PARSER,
                      extensionRegistry);
              if (dataSourcesBuilder_ == null) {
                ensureDataSourcesIsMutable();
                dataSources_.add(m);
            ...
            case 40: {
              int tmpRaw = input.readEnum();
              perfetto.protos.TraceConfig.LockdownModeOperation tmpValue =
                  perfetto.protos.TraceConfig.LockdownModeOperation.forNumber(tmpRaw);
              if (tmpValue == null) {
                mergeUnknownVarintField(5, tmpRaw);
              } else {
            ...
            case 50: {
              perfetto.protos.TraceConfig.ProducerConfig m =
                  input.readMessage(
                      perfetto.protos.TraceConfig.ProducerConfig.PARSER,
                      extensionRegistry);
              if (producersBuilder_ == null) {
                ensureProducersIsMutable();
                producers_.add(m);
            ...
            case 192: {
              int tmpRaw = input.readEnum();
              perfetto.protos.TraceConfig.CompressionType tmpValue =
                  perfetto.protos.TraceConfig.CompressionType.forNumber(tmpRaw);
              if (tmpValue == null) {
            ...
            case 248: {
              int tmpRaw = input.readEnum();
              perfetto.protos.TraceConfig.StatsdLogging tmpValue =
                  perfetto.protos.TraceConfig.StatsdLogging.forNumber(tmpRaw);
              if (tmpValue == null) {
            ...
            case 314: {
              perfetto.protos.TraceConfig.SessionSemaphore m =
                  input.readMessage(
                      perfetto.protos.TraceConfig.SessionSemaphore.PARSER,
                      extensionRegistry);
              if (sessionSemaphoresBuilder_ == null) {
                ensureSessionSemaphoresIsMutable();
                sessionSemaphores_.add(m);
              } else {
                sessionSemaphoresBuilder_.addMessage(m);
              }
              break;
            } // case 314
            default: {
    ...
    private void ensureBuffersIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        buffers_ = new java.util.ArrayList<perfetto.protos.TraceConfig.BufferConfig>(buffers_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.BufferConfig, perfetto.protos.TraceConfig.BufferConfig.Builder, perfetto.protos.TraceConfig.BufferConfigOrBuilder> buffersBuilder_;
    ...
    public Builder setBuffers(
        int index, perfetto.protos.TraceConfig.BufferConfig value) {
      if (buffersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setBuffers(
        int index, perfetto.protos.TraceConfig.BufferConfig.Builder builderForValue) {
      if (buffersBuilder_ == null) {
        ensureBuffersIsMutable();
     ...
     * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
     */
    public Builder addBuffers(perfetto.protos.TraceConfig.BufferConfig value) {
      if (buffersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBuffers(
        perfetto.protos.TraceConfig.BufferConfig.Builder builderForValue) {
      if (buffersBuilder_ == null) {
        ensureBuffersIsMutable();
    ...
    public Builder addAllBuffers(
        java.lang.Iterable<? extends perfetto.protos.TraceConfig.BufferConfig> values) {
      if (buffersBuilder_ == null) {
        ensureBuffersIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, buffers_);
     ...
     * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
     */
    public perfetto.protos.TraceConfig.BufferConfig.Builder getBuffersBuilder(
        int index) {
     ...
     * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
     */
    public perfetto.protos.TraceConfig.BufferConfig.Builder addBuffersBuilder() {
      return getBuffersFieldBuilder().addBuilder(
          perfetto.protos.TraceConfig.BufferConfig.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
     */
    public perfetto.protos.TraceConfig.BufferConfig.Builder addBuffersBuilder(
        int index) {
      return getBuffersFieldBuilder().addBuilder(
          index, perfetto.protos.TraceConfig.BufferConfig.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.BufferConfig buffers = 1;</code>
     */
    public java.util.List<perfetto.protos.TraceConfig.BufferConfig.Builder> 
         getBuffersBuilderList() {
      return getBuffersFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.BufferConfig, perfetto.protos.TraceConfig.BufferConfig.Builder, perfetto.protos.TraceConfig.BufferConfigOrBuilder> 
        getBuffersFieldBuilder() {
      if (buffersBuilder_ == null) {
    ...
    private void ensureDataSourcesIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        dataSources_ = new java.util.ArrayList<perfetto.protos.TraceConfig.DataSource>(dataSources_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.DataSource, perfetto.protos.TraceConfig.DataSource.Builder, perfetto.protos.TraceConfig.DataSourceOrBuilder> dataSourcesBuilder_;
    ...
    public Builder setDataSources(
        int index, perfetto.protos.TraceConfig.DataSource value) {
      if (dataSourcesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setDataSources(
        int index, perfetto.protos.TraceConfig.DataSource.Builder builderForValue) {
      if (dataSourcesBuilder_ == null) {
        ensureDataSourcesIsMutable();
     ...
     * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
     */
    public Builder addDataSources(perfetto.protos.TraceConfig.DataSource value) {
      if (dataSourcesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addDataSources(
        perfetto.protos.TraceConfig.DataSource.Builder builderForValue) {
      if (dataSourcesBuilder_ == null) {
        ensureDataSourcesIsMutable();
    ...
    public Builder addAllDataSources(
        java.lang.Iterable<? extends perfetto.protos.TraceConfig.DataSource> values) {
      if (dataSourcesBuilder_ == null) {
        ensureDataSourcesIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, dataSources_);
     ...
     * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
     */
    public perfetto.protos.TraceConfig.DataSource.Builder getDataSourcesBuilder(
        int index) {
     ...
     * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
     */
    public perfetto.protos.TraceConfig.DataSource.Builder addDataSourcesBuilder() {
      return getDataSourcesFieldBuilder().addBuilder(
          perfetto.protos.TraceConfig.DataSource.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
     */
    public perfetto.protos.TraceConfig.DataSource.Builder addDataSourcesBuilder(
        int index) {
      return getDataSourcesFieldBuilder().addBuilder(
          index, perfetto.protos.TraceConfig.DataSource.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.DataSource data_sources = 2;</code>
     */
    public java.util.List<perfetto.protos.TraceConfig.DataSource.Builder> 
         getDataSourcesBuilderList() {
      return getDataSourcesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.DataSource, perfetto.protos.TraceConfig.DataSource.Builder, perfetto.protos.TraceConfig.DataSourceOrBuilder> 
        getDataSourcesFieldBuilder() {
      if (dataSourcesBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.BuiltinDataSource builtinDataSources_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.BuiltinDataSource, perfetto.protos.TraceConfig.BuiltinDataSource.Builder, perfetto.protos.TraceConfig.BuiltinDataSourceOrBuilder> builtinDataSourcesBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
     * @return Whether the builtinDataSources field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
     */
    public Builder setBuiltinDataSources(perfetto.protos.TraceConfig.BuiltinDataSource value) {
      if (builtinDataSourcesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setBuiltinDataSources(
        perfetto.protos.TraceConfig.BuiltinDataSource.Builder builderForValue) {
      if (builtinDataSourcesBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
     */
    public Builder mergeBuiltinDataSources(perfetto.protos.TraceConfig.BuiltinDataSource value) {
      if (builtinDataSourcesBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          builtinDataSources_ != null &&
          builtinDataSources_ != perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
     */
    public perfetto.protos.TraceConfig.BuiltinDataSource.Builder getBuiltinDataSourcesBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.BuiltinDataSourceOrBuilder getBuiltinDataSourcesOrBuilder() {
      if (builtinDataSourcesBuilder_ != null) {
        ...
        return builtinDataSources_ == null ?
            perfetto.protos.TraceConfig.BuiltinDataSource.getDefaultInstance() : builtinDataSources_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.BuiltinDataSource builtin_data_sources = 20;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.BuiltinDataSource, perfetto.protos.TraceConfig.BuiltinDataSource.Builder, perfetto.protos.TraceConfig.BuiltinDataSourceOrBuilder> 
        getBuiltinDataSourcesFieldBuilder() {
      if (builtinDataSourcesBuilder_ == null) {
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.LockdownModeOperation getLockdownMode() {
      perfetto.protos.TraceConfig.LockdownModeOperation result = perfetto.protos.TraceConfig.LockdownModeOperation.forNumber(lockdownMode_);
      return result == null ? perfetto.protos.TraceConfig.LockdownModeOperation.LOCKDOWN_UNCHANGED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setLockdownMode(perfetto.protos.TraceConfig.LockdownModeOperation value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000040;
    ...
    private void ensureProducersIsMutable() {
      if (!((bitField0_ & 0x00000080) != 0)) {
        producers_ = new java.util.ArrayList<perfetto.protos.TraceConfig.ProducerConfig>(producers_);
        bitField0_ |= 0x00000080;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.ProducerConfig, perfetto.protos.TraceConfig.ProducerConfig.Builder, perfetto.protos.TraceConfig.ProducerConfigOrBuilder> producersBuilder_;
    ...
    public Builder setProducers(
        int index, perfetto.protos.TraceConfig.ProducerConfig value) {
      if (producersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setProducers(
        int index, perfetto.protos.TraceConfig.ProducerConfig.Builder builderForValue) {
      if (producersBuilder_ == null) {
        ensureProducersIsMutable();
     ...
     * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
     */
    public Builder addProducers(perfetto.protos.TraceConfig.ProducerConfig value) {
      if (producersBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addProducers(
        perfetto.protos.TraceConfig.ProducerConfig.Builder builderForValue) {
      if (producersBuilder_ == null) {
        ensureProducersIsMutable();
    ...
    public Builder addAllProducers(
        java.lang.Iterable<? extends perfetto.protos.TraceConfig.ProducerConfig> values) {
      if (producersBuilder_ == null) {
        ensureProducersIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, producers_);
     ...
     * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
     */
    public perfetto.protos.TraceConfig.ProducerConfig.Builder getProducersBuilder(
        int index) {
     ...
     * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
     */
    public perfetto.protos.TraceConfig.ProducerConfig.Builder addProducersBuilder() {
      return getProducersFieldBuilder().addBuilder(
          perfetto.protos.TraceConfig.ProducerConfig.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
     */
    public perfetto.protos.TraceConfig.ProducerConfig.Builder addProducersBuilder(
        int index) {
      return getProducersFieldBuilder().addBuilder(
          index, perfetto.protos.TraceConfig.ProducerConfig.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.ProducerConfig producers = 6;</code>
     */
    public java.util.List<perfetto.protos.TraceConfig.ProducerConfig.Builder> 
         getProducersBuilderList() {
      return getProducersFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.ProducerConfig, perfetto.protos.TraceConfig.ProducerConfig.Builder, perfetto.protos.TraceConfig.ProducerConfigOrBuilder> 
        getProducersFieldBuilder() {
      if (producersBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.StatsdMetadata statsdMetadata_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.StatsdMetadata, perfetto.protos.TraceConfig.StatsdMetadata.Builder, perfetto.protos.TraceConfig.StatsdMetadataOrBuilder> statsdMetadataBuilder_;
    /**
     * <pre>
     * Statsd-specific metadata.
     * </pre>
     ...
     * <code>optional .perfetto.protos.TraceConfig.StatsdMetadata statsd_metadata = 7;</code>
     */
    public Builder setStatsdMetadata(perfetto.protos.TraceConfig.StatsdMetadata value) {
      if (statsdMetadataBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setStatsdMetadata(
        perfetto.protos.TraceConfig.StatsdMetadata.Builder builderForValue) {
      if (statsdMetadataBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.StatsdMetadata statsd_metadata = 7;</code>
     */
    public Builder mergeStatsdMetadata(perfetto.protos.TraceConfig.StatsdMetadata value) {
      if (statsdMetadataBuilder_ == null) {
        if (((bitField0_ & 0x00000100) != 0) &&
          statsdMetadata_ != null &&
          statsdMetadata_ != perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.StatsdMetadata statsd_metadata = 7;</code>
     */
    public perfetto.protos.TraceConfig.StatsdMetadata.Builder getStatsdMetadataBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.StatsdMetadataOrBuilder getStatsdMetadataOrBuilder() {
      if (statsdMetadataBuilder_ != null) {
        ...
        return statsdMetadata_ == null ?
            perfetto.protos.TraceConfig.StatsdMetadata.getDefaultInstance() : statsdMetadata_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.StatsdMetadata, perfetto.protos.TraceConfig.StatsdMetadata.Builder, perfetto.protos.TraceConfig.StatsdMetadataOrBuilder> 
        getStatsdMetadataFieldBuilder() {
      if (statsdMetadataBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.GuardrailOverrides guardrailOverrides_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.GuardrailOverrides, perfetto.protos.TraceConfig.GuardrailOverrides.Builder, perfetto.protos.TraceConfig.GuardrailOverridesOrBuilder> guardrailOverridesBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
     * @return Whether the guardrailOverrides field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
     */
    public Builder setGuardrailOverrides(perfetto.protos.TraceConfig.GuardrailOverrides value) {
      if (guardrailOverridesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setGuardrailOverrides(
        perfetto.protos.TraceConfig.GuardrailOverrides.Builder builderForValue) {
      if (guardrailOverridesBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
     */
    public Builder mergeGuardrailOverrides(perfetto.protos.TraceConfig.GuardrailOverrides value) {
      if (guardrailOverridesBuilder_ == null) {
        if (((bitField0_ & 0x00002000) != 0) &&
          guardrailOverrides_ != null &&
          guardrailOverrides_ != perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
     */
    public perfetto.protos.TraceConfig.GuardrailOverrides.Builder getGuardrailOverridesBuilder() {
      bitField0_ |= 0x00002000;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.GuardrailOverridesOrBuilder getGuardrailOverridesOrBuilder() {
      if (guardrailOverridesBuilder_ != null) {
        ...
        return guardrailOverrides_ == null ?
            perfetto.protos.TraceConfig.GuardrailOverrides.getDefaultInstance() : guardrailOverrides_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.GuardrailOverrides guardrail_overrides = 11;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.GuardrailOverrides, perfetto.protos.TraceConfig.GuardrailOverrides.Builder, perfetto.protos.TraceConfig.GuardrailOverridesOrBuilder> 
        getGuardrailOverridesFieldBuilder() {
      if (guardrailOverridesBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.TriggerConfig triggerConfig_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.TriggerConfig, perfetto.protos.TraceConfig.TriggerConfig.Builder, perfetto.protos.TraceConfig.TriggerConfigOrBuilder> triggerConfigBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
     * @return Whether the triggerConfig field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
     */
    public Builder setTriggerConfig(perfetto.protos.TraceConfig.TriggerConfig value) {
      if (triggerConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setTriggerConfig(
        perfetto.protos.TraceConfig.TriggerConfig.Builder builderForValue) {
      if (triggerConfigBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
     */
    public Builder mergeTriggerConfig(perfetto.protos.TraceConfig.TriggerConfig value) {
      if (triggerConfigBuilder_ == null) {
        if (((bitField0_ & 0x00200000) != 0) &&
          triggerConfig_ != null &&
          triggerConfig_ != perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
     */
    public perfetto.protos.TraceConfig.TriggerConfig.Builder getTriggerConfigBuilder() {
      bitField0_ |= 0x00200000;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.TriggerConfigOrBuilder getTriggerConfigOrBuilder() {
      if (triggerConfigBuilder_ != null) {
        ...
        return triggerConfig_ == null ?
            perfetto.protos.TraceConfig.TriggerConfig.getDefaultInstance() : triggerConfig_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.TriggerConfig trigger_config = 17;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.TriggerConfig, perfetto.protos.TraceConfig.TriggerConfig.Builder, perfetto.protos.TraceConfig.TriggerConfigOrBuilder> 
        getTriggerConfigFieldBuilder() {
      if (triggerConfigBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.IncrementalStateConfig incrementalStateConfig_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.IncrementalStateConfig, perfetto.protos.TraceConfig.IncrementalStateConfig.Builder, perfetto.protos.TraceConfig.IncrementalStateConfigOrBuilder> incrementalStateConfigBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
     * @return Whether the incrementalStateConfig field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
     */
    public Builder setIncrementalStateConfig(perfetto.protos.TraceConfig.IncrementalStateConfig value) {
      if (incrementalStateConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setIncrementalStateConfig(
        perfetto.protos.TraceConfig.IncrementalStateConfig.Builder builderForValue) {
      if (incrementalStateConfigBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
     */
    public Builder mergeIncrementalStateConfig(perfetto.protos.TraceConfig.IncrementalStateConfig value) {
      if (incrementalStateConfigBuilder_ == null) {
        if (((bitField0_ & 0x00800000) != 0) &&
          incrementalStateConfig_ != null &&
          incrementalStateConfig_ != perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
     */
    public perfetto.protos.TraceConfig.IncrementalStateConfig.Builder getIncrementalStateConfigBuilder() {
      bitField0_ |= 0x00800000;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.IncrementalStateConfigOrBuilder getIncrementalStateConfigOrBuilder() {
      if (incrementalStateConfigBuilder_ != null) {
        ...
        return incrementalStateConfig_ == null ?
            perfetto.protos.TraceConfig.IncrementalStateConfig.getDefaultInstance() : incrementalStateConfig_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.IncrementalStateConfig incremental_state_config = 21;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.IncrementalStateConfig, perfetto.protos.TraceConfig.IncrementalStateConfig.Builder, perfetto.protos.TraceConfig.IncrementalStateConfigOrBuilder> 
        getIncrementalStateConfigFieldBuilder() {
      if (incrementalStateConfigBuilder_ == null) {
     ...
     * @return This builder for chaining.
     */
    @java.lang.Deprecated public Builder setAllowUserBuildTracing(boolean value) {
     ...
     * @return This builder for chaining.
     */
    @java.lang.Deprecated public Builder clearAllowUserBuildTracing() {
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.CompressionType getCompressionType() {
      perfetto.protos.TraceConfig.CompressionType result = perfetto.protos.TraceConfig.CompressionType.forNumber(compressionType_);
      return result == null ? perfetto.protos.TraceConfig.CompressionType.COMPRESSION_TYPE_UNSPECIFIED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setCompressionType(perfetto.protos.TraceConfig.CompressionType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x04000000;
    ...
    private perfetto.protos.TraceConfig.IncidentReportConfig incidentReportConfig_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.IncidentReportConfig, perfetto.protos.TraceConfig.IncidentReportConfig.Builder, perfetto.protos.TraceConfig.IncidentReportConfigOrBuilder> incidentReportConfigBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
     * @return Whether the incidentReportConfig field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
     */
    public Builder setIncidentReportConfig(perfetto.protos.TraceConfig.IncidentReportConfig value) {
      if (incidentReportConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setIncidentReportConfig(
        perfetto.protos.TraceConfig.IncidentReportConfig.Builder builderForValue) {
      if (incidentReportConfigBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
     */
    public Builder mergeIncidentReportConfig(perfetto.protos.TraceConfig.IncidentReportConfig value) {
      if (incidentReportConfigBuilder_ == null) {
        if (((bitField0_ & 0x08000000) != 0) &&
          incidentReportConfig_ != null &&
          incidentReportConfig_ != perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
     */
    public perfetto.protos.TraceConfig.IncidentReportConfig.Builder getIncidentReportConfigBuilder() {
      bitField0_ |= 0x08000000;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.IncidentReportConfigOrBuilder getIncidentReportConfigOrBuilder() {
      if (incidentReportConfigBuilder_ != null) {
        ...
        return incidentReportConfig_ == null ?
            perfetto.protos.TraceConfig.IncidentReportConfig.getDefaultInstance() : incidentReportConfig_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.IncidentReportConfig incident_report_config = 25;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.IncidentReportConfig, perfetto.protos.TraceConfig.IncidentReportConfig.Builder, perfetto.protos.TraceConfig.IncidentReportConfigOrBuilder> 
        getIncidentReportConfigFieldBuilder() {
      if (incidentReportConfigBuilder_ == null) {
     ...
     */
    @java.lang.Override
    public perfetto.protos.TraceConfig.StatsdLogging getStatsdLogging() {
      perfetto.protos.TraceConfig.StatsdLogging result = perfetto.protos.TraceConfig.StatsdLogging.forNumber(statsdLogging_);
      return result == null ? perfetto.protos.TraceConfig.StatsdLogging.STATSD_LOGGING_UNSPECIFIED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setStatsdLogging(perfetto.protos.TraceConfig.StatsdLogging value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x10000000;
    ...
    private perfetto.protos.TraceConfig.TraceFilter traceFilter_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.TraceFilter, perfetto.protos.TraceConfig.TraceFilter.Builder, perfetto.protos.TraceConfig.TraceFilterOrBuilder> traceFilterBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
     * @return Whether the traceFilter field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
     */
    public Builder setTraceFilter(perfetto.protos.TraceConfig.TraceFilter value) {
      if (traceFilterBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setTraceFilter(
        perfetto.protos.TraceConfig.TraceFilter.Builder builderForValue) {
      if (traceFilterBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
     */
    public Builder mergeTraceFilter(perfetto.protos.TraceConfig.TraceFilter value) {
      if (traceFilterBuilder_ == null) {
        if (((bitField0_ & 0x80000000) != 0) &&
          traceFilter_ != null &&
          traceFilter_ != perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
     */
    public perfetto.protos.TraceConfig.TraceFilter.Builder getTraceFilterBuilder() {
      bitField0_ |= 0x80000000;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.TraceFilterOrBuilder getTraceFilterOrBuilder() {
      if (traceFilterBuilder_ != null) {
        ...
        return traceFilter_ == null ?
            perfetto.protos.TraceConfig.TraceFilter.getDefaultInstance() : traceFilter_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.TraceFilter trace_filter = 33;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.TraceFilter, perfetto.protos.TraceConfig.TraceFilter.Builder, perfetto.protos.TraceConfig.TraceFilterOrBuilder> 
        getTraceFilterFieldBuilder() {
      if (traceFilterBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.AndroidReportConfig androidReportConfig_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.AndroidReportConfig, perfetto.protos.TraceConfig.AndroidReportConfig.Builder, perfetto.protos.TraceConfig.AndroidReportConfigOrBuilder> androidReportConfigBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
     * @return Whether the androidReportConfig field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
     */
    public Builder setAndroidReportConfig(perfetto.protos.TraceConfig.AndroidReportConfig value) {
      if (androidReportConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setAndroidReportConfig(
        perfetto.protos.TraceConfig.AndroidReportConfig.Builder builderForValue) {
      if (androidReportConfigBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
     */
    public Builder mergeAndroidReportConfig(perfetto.protos.TraceConfig.AndroidReportConfig value) {
      if (androidReportConfigBuilder_ == null) {
        if (((bitField1_ & 0x00000001) != 0) &&
          androidReportConfig_ != null &&
          androidReportConfig_ != perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
     */
    public perfetto.protos.TraceConfig.AndroidReportConfig.Builder getAndroidReportConfigBuilder() {
      bitField1_ |= 0x00000001;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.AndroidReportConfigOrBuilder getAndroidReportConfigOrBuilder() {
      if (androidReportConfigBuilder_ != null) {
        ...
        return androidReportConfig_ == null ?
            perfetto.protos.TraceConfig.AndroidReportConfig.getDefaultInstance() : androidReportConfig_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.AndroidReportConfig android_report_config = 34;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.AndroidReportConfig, perfetto.protos.TraceConfig.AndroidReportConfig.Builder, perfetto.protos.TraceConfig.AndroidReportConfigOrBuilder> 
        getAndroidReportConfigFieldBuilder() {
      if (androidReportConfigBuilder_ == null) {
    ...
    private perfetto.protos.TraceConfig.CmdTraceStartDelay cmdTraceStartDelay_;
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.CmdTraceStartDelay, perfetto.protos.TraceConfig.CmdTraceStartDelay.Builder, perfetto.protos.TraceConfig.CmdTraceStartDelayOrBuilder> cmdTraceStartDelayBuilder_;
    /**
     * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
     * @return Whether the cmdTraceStartDelay field is set.
     */
     ...
     * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
     */
    public Builder setCmdTraceStartDelay(perfetto.protos.TraceConfig.CmdTraceStartDelay value) {
      if (cmdTraceStartDelayBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setCmdTraceStartDelay(
        perfetto.protos.TraceConfig.CmdTraceStartDelay.Builder builderForValue) {
      if (cmdTraceStartDelayBuilder_ == null) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
     */
    public Builder mergeCmdTraceStartDelay(perfetto.protos.TraceConfig.CmdTraceStartDelay value) {
      if (cmdTraceStartDelayBuilder_ == null) {
        if (((bitField1_ & 0x00000002) != 0) &&
          cmdTraceStartDelay_ != null &&
          cmdTraceStartDelay_ != perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance()) {
     ...
     * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
     */
    public perfetto.protos.TraceConfig.CmdTraceStartDelay.Builder getCmdTraceStartDelayBuilder() {
      bitField1_ |= 0x00000002;
      onChanged();
    ...
    public perfetto.protos.TraceConfig.CmdTraceStartDelayOrBuilder getCmdTraceStartDelayOrBuilder() {
      if (cmdTraceStartDelayBuilder_ != null) {
        ...
        return cmdTraceStartDelay_ == null ?
            perfetto.protos.TraceConfig.CmdTraceStartDelay.getDefaultInstance() : cmdTraceStartDelay_;
      }
    }
    /**
     * <code>optional .perfetto.protos.TraceConfig.CmdTraceStartDelay cmd_trace_start_delay = 35;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        perfetto.protos.TraceConfig.CmdTraceStartDelay, perfetto.protos.TraceConfig.CmdTraceStartDelay.Builder, perfetto.protos.TraceConfig.CmdTraceStartDelayOrBuilder> 
        getCmdTraceStartDelayFieldBuilder() {
      if (cmdTraceStartDelayBuilder_ == null) {
    ...
    private void ensureSessionSemaphoresIsMutable() {
      if (!((bitField1_ & 0x00000004) != 0)) {
        sessionSemaphores_ = new java.util.ArrayList<perfetto.protos.TraceConfig.SessionSemaphore>(sessionSemaphores_);
        bitField1_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.SessionSemaphore, perfetto.protos.TraceConfig.SessionSemaphore.Builder, perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder> sessionSemaphoresBuilder_;
    ...
    public java.util.List<perfetto.protos.TraceConfig.SessionSemaphore> getSessionSemaphoresList() {
      if (sessionSemaphoresBuilder_ == null) {
        return java.util.Collections.unmodifiableList(sessionSemaphores_);
      } else {
        return sessionSemaphoresBuilder_.getMessageList();
      }
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
    ...
    public int getSessionSemaphoresCount() {
      if (sessionSemaphoresBuilder_ == null) {
        ...
        return sessionSemaphoresBuilder_.getCount();
      }
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
    ...
    public perfetto.protos.TraceConfig.SessionSemaphore getSessionSemaphores(int index) {
      if (sessionSemaphoresBuilder_ == null) {
        ...
        return sessionSemaphoresBuilder_.getMessage(index);
      }
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public Builder setSessionSemaphores(
        int index, perfetto.protos.TraceConfig.SessionSemaphore value) {
      if (sessionSemaphoresBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.set(index, value);
        onChanged();
      } else {
        sessionSemaphoresBuilder_.setMessage(index, value);
      }
      return this;
    }
    /**
     ...
     */
    public Builder setSessionSemaphores(
        int index, perfetto.protos.TraceConfig.SessionSemaphore.Builder builderForValue) {
      if (sessionSemaphoresBuilder_ == null) {
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.set(index, builderForValue.build());
        onChanged();
      } else {
        sessionSemaphoresBuilder_.setMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public Builder addSessionSemaphores(perfetto.protos.TraceConfig.SessionSemaphore value) {
      if (sessionSemaphoresBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.add(value);
        onChanged();
      } else {
        sessionSemaphoresBuilder_.addMessage(value);
      }
      return this;
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public Builder addSessionSemaphores(
        int index, perfetto.protos.TraceConfig.SessionSemaphore value) {
      if (sessionSemaphoresBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        ...
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.add(index, value);
        onChanged();
      } else {
        sessionSemaphoresBuilder_.addMessage(index, value);
      }
      return this;
    }
    /**
     ...
     */
    public Builder addSessionSemaphores(
        perfetto.protos.TraceConfig.SessionSemaphore.Builder builderForValue) {
      if (sessionSemaphoresBuilder_ == null) {
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.add(builderForValue.build());
        onChanged();
      } else {
        sessionSemaphoresBuilder_.addMessage(builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addSessionSemaphores(
      ...
      if (sessionSemaphoresBuilder_ == null) {
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.add(index, builderForValue.build());
        onChanged();
      } else {
        sessionSemaphoresBuilder_.addMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public Builder addAllSessionSemaphores(
        java.lang.Iterable<? extends perfetto.protos.TraceConfig.SessionSemaphore> values) {
      if (sessionSemaphoresBuilder_ == null) {
        ensureSessionSemaphoresIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, sessionSemaphores_);
        onChanged();
      } else {
        sessionSemaphoresBuilder_.addAllMessages(values);
      }
      return this;
    }
    /**
     ...
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public Builder removeSessionSemaphores(int index) {
      if (sessionSemaphoresBuilder_ == null) {
        ensureSessionSemaphoresIsMutable();
        sessionSemaphores_.remove(index);
        onChanged();
      } else {
        sessionSemaphoresBuilder_.remove(index);
      }
      return this;
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public perfetto.protos.TraceConfig.SessionSemaphore.Builder getSessionSemaphoresBuilder(
        int index) {
      return getSessionSemaphoresFieldBuilder().getBuilder(index);
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder getSessionSemaphoresOrBuilder(
        int index) {
      if (sessionSemaphoresBuilder_ == null) {
        return sessionSemaphores_.get(index);  } else {
        return sessionSemaphoresBuilder_.getMessageOrBuilder(index);
      }
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
    ...
    public java.util.List<? extends perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder> 
         getSessionSemaphoresOrBuilderList() {
      if (sessionSemaphoresBuilder_ != null) {
        return sessionSemaphoresBuilder_.getMessageOrBuilderList();
      } else {
        return java.util.Collections.unmodifiableList(sessionSemaphores_);
      }
    }
     ...
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public perfetto.protos.TraceConfig.SessionSemaphore.Builder addSessionSemaphoresBuilder() {
      return getSessionSemaphoresFieldBuilder().addBuilder(
          perfetto.protos.TraceConfig.SessionSemaphore.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public perfetto.protos.TraceConfig.SessionSemaphore.Builder addSessionSemaphoresBuilder(
        int index) {
      return getSessionSemaphoresFieldBuilder().addBuilder(
          index, perfetto.protos.TraceConfig.SessionSemaphore.getDefaultInstance());
    }
    /**
     * <code>repeated .perfetto.protos.TraceConfig.SessionSemaphore session_semaphores = 39;</code>
     */
    public java.util.List<perfetto.protos.TraceConfig.SessionSemaphore.Builder> 
         getSessionSemaphoresBuilderList() {
      return getSessionSemaphoresFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        perfetto.protos.TraceConfig.SessionSemaphore, perfetto.protos.TraceConfig.SessionSemaphore.Builder, perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder> 
        getSessionSemaphoresFieldBuilder() {
      if (sessionSemaphoresBuilder_ == null) {
        sessionSemaphoresBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            perfetto.protos.TraceConfig.SessionSemaphore, perfetto.protos.TraceConfig.SessionSemaphore.Builder, perfetto.protos.TraceConfig.SessionSemaphoreOrBuilder>(
                sessionSemaphores_,
      ...
      return sessionSemaphoresBuilder_;
    }
    @java.lang.Override
    public final Builder setUnknownFields(
        final com.google.protobuf.UnknownFieldSet unknownFields) {
  ...
  private static final perfetto.protos.TraceConfig DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new perfetto.protos.TraceConfig();
  }

  public static perfetto.protos.TraceConfig getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
