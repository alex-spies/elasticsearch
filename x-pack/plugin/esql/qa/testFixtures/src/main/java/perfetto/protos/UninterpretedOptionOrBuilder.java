...
public interface UninterpretedOptionOrBuilder extends
   ...
   */
  java.util.List<perfetto.protos.UninterpretedOption.NamePart> 
      getNameList();
  /**
   * <code>repeated .perfetto.protos.UninterpretedOption.NamePart name = 2;</code>
   */
  perfetto.protos.UninterpretedOption.NamePart getName(int index);
  /**
   * <code>repeated .perfetto.protos.UninterpretedOption.NamePart name = 2;</code>
   */
  int getNameCount();
   ...
   * <code>repeated .perfetto.protos.UninterpretedOption.NamePart name = 2;</code>
   */
  java.util.List<? extends perfetto.protos.UninterpretedOption.NamePartOrBuilder> 
      getNameOrBuilderList();
  /**
   * <code>repeated .perfetto.protos.UninterpretedOption.NamePart name = 2;</code>
   */
  perfetto.protos.UninterpretedOption.NamePartOrBuilder getNameOrBuilder(
      int index);
