 ...
 */
public final class CounterDescriptor extends
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_CounterDescriptor_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_CounterDescriptor_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            perfetto.protos.CounterDescriptor.class, perfetto.protos.CounterDescriptor.Builder.class);
  }
  ...
  public enum BuiltinCounterType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return perfetto.protos.CounterDescriptor.getDescriptor().getEnumTypes().get(0);
    }
  ...
  public enum Unit
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return perfetto.protos.CounterDescriptor.getDescriptor().getEnumTypes().get(1);
    }
   ...
   * @return The type.
   */
  @java.lang.Override public perfetto.protos.CounterDescriptor.BuiltinCounterType getType() {
    perfetto.protos.CounterDescriptor.BuiltinCounterType result = perfetto.protos.CounterDescriptor.BuiltinCounterType.forNumber(type_);
    return result == null ? perfetto.protos.CounterDescriptor.BuiltinCounterType.COUNTER_UNSPECIFIED : result;
  }
   ...
   * @return The unit.
   */
  @java.lang.Override public perfetto.protos.CounterDescriptor.Unit getUnit() {
    perfetto.protos.CounterDescriptor.Unit result = perfetto.protos.CounterDescriptor.Unit.forNumber(unit_);
    return result == null ? perfetto.protos.CounterDescriptor.Unit.UNIT_UNSPECIFIED : result;
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof perfetto.protos.CounterDescriptor)) {
      return super.equals(obj);
    }
    perfetto.protos.CounterDescriptor other = (perfetto.protos.CounterDescriptor) obj;
  ...
  public static perfetto.protos.CounterDescriptor parseFrom(
  ...
  public static perfetto.protos.CounterDescriptor parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static perfetto.protos.CounterDescriptor parseFrom(
  ...
  public static perfetto.protos.CounterDescriptor parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static perfetto.protos.CounterDescriptor parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static perfetto.protos.CounterDescriptor parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(perfetto.protos.CounterDescriptor prototype) {
  ...
  public static final class Builder extends
      ...
      perfetto.protos.CounterDescriptorOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return perfetto.protos.PerfettoTrace.internal_static_perfetto_protos_CounterDescriptor_descriptor;
    }
    ...
    // Construct using perfetto.protos.CounterDescriptor.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public perfetto.protos.CounterDescriptor getDefaultInstanceForType() {
      return perfetto.protos.CounterDescriptor.getDefaultInstance();
    }

    @java.lang.Override
    public perfetto.protos.CounterDescriptor build() {
      perfetto.protos.CounterDescriptor result = buildPartial();
    ...
    @java.lang.Override
    public perfetto.protos.CounterDescriptor buildPartial() {
      perfetto.protos.CounterDescriptor result = new perfetto.protos.CounterDescriptor(this);
    ...
    private void buildPartialRepeatedFields(perfetto.protos.CounterDescriptor result) {
      if (((bitField0_ & 0x00000002) != 0)) {
    ...
    private void buildPartial0(perfetto.protos.CounterDescriptor result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof perfetto.protos.CounterDescriptor) {
        return mergeFrom((perfetto.protos.CounterDescriptor)other);
      } else {
    ...
    public Builder mergeFrom(perfetto.protos.CounterDescriptor other) {
      if (other == perfetto.protos.CounterDescriptor.getDefaultInstance()) return this;
      if (other.hasType()) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              perfetto.protos.CounterDescriptor.BuiltinCounterType tmpValue =
                  perfetto.protos.CounterDescriptor.BuiltinCounterType.forNumber(tmpRaw);
              if (tmpValue == null) {
            ...
            case 24: {
              int tmpRaw = input.readEnum();
              perfetto.protos.CounterDescriptor.Unit tmpValue =
                  perfetto.protos.CounterDescriptor.Unit.forNumber(tmpRaw);
              if (tmpValue == null) {
     ...
     */
    @java.lang.Override
    public perfetto.protos.CounterDescriptor.BuiltinCounterType getType() {
      perfetto.protos.CounterDescriptor.BuiltinCounterType result = perfetto.protos.CounterDescriptor.BuiltinCounterType.forNumber(type_);
      return result == null ? perfetto.protos.CounterDescriptor.BuiltinCounterType.COUNTER_UNSPECIFIED : result;
    }
    /**
     ...
     */
    public Builder setType(perfetto.protos.CounterDescriptor.BuiltinCounterType value) {
      if (value == null) {
     ...
     */
    @java.lang.Override
    public perfetto.protos.CounterDescriptor.Unit getUnit() {
      perfetto.protos.CounterDescriptor.Unit result = perfetto.protos.CounterDescriptor.Unit.forNumber(unit_);
      return result == null ? perfetto.protos.CounterDescriptor.Unit.UNIT_UNSPECIFIED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setUnit(perfetto.protos.CounterDescriptor.Unit value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000004;
  ...
  private static final perfetto.protos.CounterDescriptor DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new perfetto.protos.CounterDescriptor();
  }

  public static perfetto.protos.CounterDescriptor getDefaultInstance() {
